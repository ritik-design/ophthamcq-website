...
primary_keyword: "proptosis examination"
secondary_keywords: ["proptosis short case", "Hertel exophthalmometry examination", "proptosis viva examination"]
target_page: "/osce"
estimated_read_time: "11 minutes"
fact_check_date: "2026-08-18"
research_brief: "docs/content-research/051-proptosis-examination-serp-brief.md"
---
...
1. Is the appearance unilateral or bilateral?
2. Is the globe actually forward, or is there an asymmetry that could mimic proptosis?
3. Does the globe appear to move directly forward or away from a particular orbital quadrant?
4. Are there lid, conjunctival or corneal exposure signs?
5. Is there facial asymmetry, periocular swelling, a scar, skin change or a visible mass?
...
1. **Visual acuity:** record each eye separately with correction/pinhole as the station permits.
2. **Pupils:** compare size and reactions; look for an RAPD when appropriate.
3. **Colour vision:** use plates or red desaturation if available and relevant.
4. **Fields:** perform confrontation testing if time and the scenario justify it.
5. **Motility and diplopia:** assess versions in the nine positions, then ask about diplopia rather than inferring it from a limited movement.
6. **Fundus:** look for disc swelling, pallor, choroidal folds or vascular congestion when the station allows.
...
|---|---|---|---|---|---|---|
| Finish the eye, lids and surface | `/topics/oculoplastics` | Oculoplastics MCQs & Guide | oculoplastics study guide | BODY_CONTEXTUAL | broader subspecialty revision | P2 |
| Rehearse the sequence | `/osce` | OSCE, Practical & Viva Voce Ready Bundle | OSCE, Practical & Viva Voce Ready bundle | CTA | primary practical-preparation route | P0 |
| Rehearse the sequence | `/products/case-presentation-format-notes` | Ophthalmology Case Presentation Format | Ophthalmology Case Presentation Format | BODY_CONTEXTUAL | relevant structured-presentation resource | P2 |

**Inbound opportunities:** add a contextual link from `/osce` in its short-case or orbit-related practical copy; from `/topics/oculoplastics` beside orbital examination material; and from `/resources` where it directs residents to practical study resources. Do not link this proposed blog URL internally until it is published through theStacc and sitemap-verified.

[^1]: [Topilow NJ et al. *Etiologies of Proptosis: A Review*](https://pmc.ncbi.nlm.nih.gov/articles/PMC7204542/), checked 18 August 2026.
[^2]: [Douglas RS et al. ATA/ETA Consensus Statement on Management of Thyroid Eye Disease](https://pmc.ncbi.nlm.nih.gov/articles/PMC9727317/), checked 18 August 2026.
[^3]: [Butt S, Patel BC. *Exophthalmos*](https://www.ncbi.nlm.nih.gov/books/NBK559323/), accessed 18 August 2026.

## Sources

1. [Topilow NJ et al. *Etiologies of Proptosis: A Review*](https://pmc.ncbi.nlm.nih.gov/articles/PMC7204542/) — systematic orbital history/examination, Hertel measurement, globe displacement, optic-nerve-function assessment and differential structure; checked 18 August 2026.
2. [Douglas RS et al. ATA/ETA Consensus Statement on Management of Thyroid Eye Disease](https://pmc.ncbi.nlm.nih.gov/articles/PMC9727317/) — standardised examination domains and documented visual, motility, proptosis, lid and exposure findings; checked 18 August 2026.
3. [Butt S, Patel BC. *Exophthalmos*](https://www.ncbi.nlm.nih.gov/books/NBK559323/) — definition, broad eye examination and exophthalmometry principle; accessed 18 August 2026 (updated 26 June 2023).

## QA

**Factuality 5/5:** substantive examination claims are tied to a peer-reviewed review, NCBI review and professional consensus statement. **Search intent 5/5:** directly answers how to perform, measure and present a proptosis examination. **Reader value 5/5:** provides a timed sequence, spoken formula, rehearsal card and error corrections. **Information gain 5/5:** turns source-led examination domains into a five-minute short-case routine while distinguishing signs from diagnosis. **Competitive superiority 4/5:** practical source-labelled presentation structure exceeds generic checklist pages. **SEO 5/5; GEO 5/5; Naturalness 5/5.** **E-E-A-T 4/5:** authoritative sources used; no fabricated experience or credentials. **Experience integrity 5/5.** **Internal linking 5/5:** all three links are verified, relevant ophthamcq.org routes; no unpublished blog links. **Conversion 4/5:** optional, relevant practical-resource route. **Freshness 4/5:** sources checked 18 August 2026; final editorial check remains required.
