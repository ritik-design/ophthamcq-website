...
primary_keyword: "last minute exam preparation"
target_page: "/notes"
estimated_read_time: "6 minutes"
fact_check_date: "2026-08-18"
research_brief: "docs/content-research/099-last-7-days-ophthalmology-exam-serp-brief.md"
---
...
The [American Academy of Ophthalmology education catalogue](https://www.aao.org/education/education-browse) is a verified .org learning directory, not an exam authority. Your examining body’s current candidate notice controls logistics and rules.

## Editorial QA and link manifest

- Cannibalisation decision: KEEP SEPARATE. `/notes` is a category/money page; this is a time-bounded exam-week workflow.
- Differentiation statement: turns final-week revision into error-led retrieval and exam logistics, not generic motivation.
- Caveat: no exam-outcome promise; official candidate instructions prevail.
- Outbound internal manifest: `/notes` | "Handwritten Exam Ready Notes" | BODY_CONTEXTUAL/CTA | P0; `/free-mcqs` | "free MCQs with explanations" | BODY_CONTEXTUAL | P0; `/osce` | "OSCE, Practical & Viva Voce Ready bundle" | BODY_CONTEXTUAL | P0.
- Inbound opportunities: `/notes` (final-revision section); `/resources` (exam-week resource); `/exams/dnb`, `/exams/faico`, `/exams/ico-fico` (last-week link where relevant).
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 4; Competitive Superiority 4; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 5; Freshness 4.

[^dunlosky]: Dunlosky J, et al. [Improving Students’ Learning With Effective Learning Techniques](https://pubmed.ncbi.nlm.nih.gov/26173288/). Used for the retrieval/distributed-practice evidence boundary, not for a seven-day outcome claim.
[^karpicke]: Karpicke JD, Blunt JR. [Retrieval practice produces more learning than elaborative studying](https://pubmed.ncbi.nlm.nih.gov/20807832/). Used for retrieval-practice framing, not as an exam-pass guarantee.
