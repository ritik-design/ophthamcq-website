---
title: "A 3-Month DNB Ophthalmology Study Plan: Week by Week"
proposed_slug: "a-3-month-dnb-ophthalmology-study-plan-week-by-week"
meta_description: "A flexible 12-week DNB Ophthalmology revision plan for residents balancing clinical work, theory, questions and practical rehearsal."
excerpt: "A three-month DNB plan works when it protects retrieval, error review and practical fluency instead of pretending every resident has twelve perfect weeks."
category: "Resources"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "longform-researched-draft"
primary_keyword: "dnb ophthalmology study plan"
target_page: "/exams/dnb"
...
This is a framework, not a statement of the current NBEMS timetable, paper count, marks, case mix or station list. NBEMS’s [DNB/DrNB Exit Examinations page](https://natboard.edu.in/viewnbeexam?exam=dnb) is the authority for the current Final process, and its [curriculum library](https://nbe.edu.in/curriculum.html) is the appropriate starting point for training scope. Dates, eligibility and candidate instructions are session-specific. Check your own current NBEMS communication before turning these weeks into a calendar.

| Phase | Weeks | Main job | Evidence at the end |
|---|---:|---|---|
| Diagnose | 1–2 | Find gaps that cost marks or fluency | error ledger and priority map |
| Build | 3–6 | Repair core systems through question-led reading | topic loops and mixed retrieval |
| Integrate | 7–9 | Connect images, investigations and answer structure | timed answers and oral explanations |
| Simulate | 10–12 | Make recall usable; retain practical rehearsal | simulations, rehearsals and taper |

## Before week 1: make an exam dossier and capacity map

Save the current NBEMS examination page, applicable notice or bulletin, curriculum location and candidate communications in one folder. The live [NBEMS practical-exam portal](https://exam.natboard.edu.in/candidates/viewpracticalexam.php) is session-specific; it and your official instructions control practical logistics, not a previous batch’s recollection. This article cannot tell you what will occur in your sitting.

Then mark capacity honestly. A resident with OPD and calls should not borrow the timetable of someone on leave.

| Week type | Minimum | Standard approach |
|---|---|---|
| Normal clinical week | five 45-minute blocks and one review | five 75-minute blocks plus two weekend sessions |
...
- [NBEMS: DNB/DrNB Exit Examinations](https://natboard.edu.in/viewnbeexam?exam=dnb) — official current gateway for DNB Final notices/process; checked 18 August 2026.
- [NBEMS curriculum library](https://nbe.edu.in/curriculum.html) — official location for current DNB curriculum documents; checked 18 August 2026.
- [NBEMS practical-exam portal](https://exam.natboard.edu.in/candidates/viewpracticalexam.php) — session-specific candidate-information portal; checked 18 August 2026.
...
- **Cannibalisation:** KEEP SEPARATE from queues 16–18; this article schedules theory, retrieval and practical rehearsal rather than explaining those topics separately.
- **Differentiation:** capacity-based week modes, error-tagged loops and fall-behind triage replace a leave-only timetable.
- **Education boundary:** postgraduate examination study guidance only; no patient-specific advice, NBEMS endorsement or outcome guarantee.
- **Outbound internal manifest:** `/exams/dnb` (DNB Ophthalmology preparation guide; P0); `/free-mcqs/general` (mixed retrieval; P2); `/topics/cataract`, `/topics/glaucoma`, `/topics/retina` (topic maps; P1); `/products/dnb-do-past-5-year-papers` (sample/current-details route; P1); `/osce`, `/products/case-presentation-format-notes`, `/products/instruments-drugs-practical-viva` (practical study routes; P0/P2); `/free-mcqs` (category-based recovery practice; P0). All are verified BODY_CONTEXTUAL routes.
- **Inbound opportunities:** `/exams/dnb` timeline/study-method section; `/resources` DNB planning list; `/osce` theory/practical-rehearsal copy; DNB/DO past-paper product use guidance. Add only after the final article URL appears in the live sitemap.
- **QA vector:** Factuality 5/5; Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5; Conversion 4/5; Freshness 4/5 (session documents need final check).
