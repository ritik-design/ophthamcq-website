...
1. **Check reliability and acquisition.** For a visual field, start with fixation/false-positive/false-negative context and the visual plausibility of the plot. For OCT, check signal, segmentation, centration and scan quality. Do not call progression from a poor test.
2. **Describe the pattern.** Is there localised or diffuse RNFL/GCC loss? Does the field show a glaucomatous pattern, or a defect that needs another explanation?
3. **Seek structure–function agreement.** Map an inferior RNFL defect to the expected superior field region, for example. Discordance is not an inconvenience; it is the question.
4. **Compare with baseline.** Distinguish a one-off abnormal result from a repeatable trend. Explain why test variability matters.
5. **State the conclusion and the next information needed.** Do not jump from a red sector to a procedure name.
...
1. What is the mechanism of pressure elevation or nerve damage?
2. What is the angle status and what has changed it?
3. What parallel ocular/systemic problem is driving the case?
4. What immediate danger or surgical limitation must the examiner know you recognise?
...
|---|---|---|---|---|
| Weekly loop | `/topics/glaucoma` | glaucoma study guide | BODY_CONTEXTUAL | Relevant topic hub. |
| FAICO context | `/exams/faico` | FAICO preparation guide | BODY_CONTEXTUAL | P0 examination route. |
| Practice | `/free-mcqs/faico` | free FAICO sample questions | BODY_CONTEXTUAL | Specific exam practice route. |
| Optional resource | `/products/glaucoma-notes` | Glaucoma Notes | BODY_CONTEXTUAL | Relevant underlinked P0 product preview. |

**Inbound opportunities:** `/topics/glaucoma` near advanced interpretation; `/exams/faico` under specialty preparation; `/products/glaucoma-notes` beside preview use cases. Do not add a live link to this draft’s blog slug until publication verifies it.

## Sources

1. [All India Ophthalmological Society: About FAICO](https://www.aios.org/article-66-about-faico.php) — primary source confirming Glaucoma as a FAICO fellowship award and for current general context; checked 18 August 2026.
2. [European Glaucoma Society Guidelines, 5th Edition](https://bjo.bmj.com/content/105/Suppl_1/1) — peer-reviewed professional framework for glaucoma assessment and care principles; accessed for exam-reference context.
3. [American Academy of Ophthalmology: Primary Open-Angle Glaucoma Preferred Practice Pattern](https://www.aao.org/preferred-practice-pattern/primary-open-angle-glaucoma-ppp) — professional guidance for assessment and longitudinal management principles.
4. [NICE NG81: Glaucoma](https://www.nice.org.uk/guidance/ng81) — guideline context for diagnosis and management pathways; local protocols and current updates prevail.

## QA

**Factuality 5/5:** does not invent an AIOS syllabus, question pattern, marks or pass rate; operational context is attributed. **Search Intent 5/5:** answers what to revise and how to rehearse it. **Reader Value 5/5:** provides a decision map, image script and complication notebook. **Information Gain 5/5:** replaces vague “high yield” lists with evidence-to-decision practice. **Competitive Superiority 4/5:** source hierarchy and explicit blueprint limitation improve on promotional pages. **SEO 5/5:** intent-matched headings and entity coverage. **GEO 5/5:** direct answer, tables and linked sources. **Naturalness 5/5:** specialist peer voice without filler. **E-E-A-T 5/5:** guideline-bound clinical claims. **Experience Integrity 5/5:** no fabricated candidate experience. **Internal Linking 5/5:** four verified routes, no unpublished blog links. **Conversion 4/5:** product is optional and clearly non-official. **Freshness 4/5:** guideline and AIOS links need a final publication-day review.
