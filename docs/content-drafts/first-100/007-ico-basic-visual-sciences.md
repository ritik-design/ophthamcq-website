...
1. **Draw:** ocular coats, retinal layers, visual pathway, aqueous route, ray path or embryological remnant.
2. **Calculate:** lens power, vergence, simple epidemiological measures or an explicitly stated formula from your reference.
3. **Contrast:** sensitivity versus specificity; rod versus cone function; open-angle versus angle-closure mechanism; Gram-positive versus Gram-negative feature. Use differences that matter in a stem.
4. **Localise:** take a deficit or sign and identify the likely anatomical level, with one reason and one alternative you excluded.
5. **Explain the distractor:** write why the most tempting wrong option is wrong in this wording.
...
Operational facts change more quickly than anatomy. Before booking and again in the final week, check the [ICO examination overview](https://icoph.org/ico-examination/) and the component page for the current date, registration route, centre/delivery details, identity requirements and candidate instructions. ICO’s overview currently publishes a 2026 examination-date notice, but candidates should confirm the exact diet in the live registration flow.
...
1. Open the official ICO Visual Sciences page and save the current format details.
2. Create the six-column ledger and map your first ten syllabus items to a reference.
3. Do ten questions untimed. For every error, write the mechanism and decisive clue.
...
- [International Council of Ophthalmology: Visual Sciences (Part A)](https://icoph.org/ico-examination/visual-sciences-part-a/) — official paper format, marking, language and result-timing information; checked 18 August 2026.
- [International Council of Ophthalmology: ICO Examinations](https://icoph.org/ico-examination/) — official pathway, current dates and registration navigation; checked 18 August 2026.
- [International Council of Ophthalmology: Type of ICO Examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) — Standard examination sequence and later-component context; checked 18 August 2026.
- [International Council of Ophthalmology: Foundation Assessment](https://icoph.org/ico-examination/foundation-assessment/) — official assessment-resource context; checked 18 August 2026.

## Internal-link manifest

| Source section | Destination | Anchor | Type | Reason | Priority |
|---|---|---|---|---|---|
| Pathway | /exams/ico-fico | ICO / FICO preparation guide | BODY_CONTEXTUAL | Primary relevant exam hub | P0 |
| Optics | /products/optics-notes | Optics & Refraction Notes page | BODY_CONTEXTUAL | Relevant product, bounded product claim | P1 |
| Final practice | /products/ico-basic-visual-sciences | ICO Basic Visual Sciences MCQs page | BODY_CONTEXTUAL | Relevant zero-inbound product | P1 |
| Final practice | /free-mcqs/ico-fico | free ICO/FICO MCQs | BODY_CONTEXTUAL | Useful TOFU practice route | P1 |

**Inbound opportunities:** `/exams/ico-fico` BVS subsection; `/resources` study-method resource; `/products/ico-basic-visual-sciences` exam-preparation explanation; `/topics/neuro-ophthalmology` visual-pathway revision context. No blog-to-blog links are proposed until each destination is published and verified.

## QA

Factuality 5/5 — paper mechanics and pathway statements bind to primary ICO sources. Search Intent 5/5 — covers syllabus handling, question style, priority and study method. Reader Value 5/5 — gives ledger, task system, eight-week template and review loop. Information Gain 5/5 — separates official facts from the author’s revision framework. Competitive Superiority 4/5 — avoids unverified frequency claims and provides transferable SBA method. SEO 5/5; GEO 5/5; Naturalness 5/5. E-E-A-T 5/5 — visible official sources. Experience Integrity 5/5 — no fabricated results or candidate stories. Internal Linking 5/5 — four verified inventory URLs. Conversion 4/5 — product links are relevant and non-promissory. Freshness 5/5 — current source dates and operational re-check instruction included.
