...
> **Current-pattern caveat:** examination format, eligibility, schedule and instructions are session-specific. The [NBEMS DNB/DrNB Final page](https://natboard.edu.in/viewnbeexam?exam=dnb) and the current information bulletin take precedence over this article, old papers and coaching notes. Checked 18 August 2026.

## What NBEMS currently confirms—and what it does not

NBEMS’s live DNB/DrNB Final material confirms the broad two-stage pathway and points candidates to current session documents, application links, notices, results and old papers. The [DNB Broad Specialty page](https://natboard.edu.in/dnbbroad) likewise describes the final examination as theory plus practical, with eligibility tied to prescribed training and the applicable information bulletin.
...
1. Download or record the official paper where NBEMS makes it available.
2. Name the file with year, session, subject and source: `2024-Jun-Ophthalmology-NBEMS.pdf`.
3. Record whether it is original, scanned, recall-based or incomplete.
4. Preserve the question wording, images and subdivisions. “Glaucoma question” is not enough.
5. Exclude duplicates and uncertain dates from numerical counts, but retain them in a separate “context only” tab.
6. Review the applicable current bulletin separately. Old papers teach topic language and answer depth; they do not publish the future exam.
...
|---|---|---|---|---|
| Integrated revision | `/exams/dnb` | DNB preparation guide | BODY_CONTEXTUAL | P0 exam hub. |
| Paper-resource context | `/products/dnb-do-past-5-year-papers` | DNB/DO past 5-year papers product page | BODY_CONTEXTUAL | Zero-inbound P1 product; explicitly optional. |
| Practical integration | `/osce` | OSCE, Practical & Viva Voce Ready | BODY_CONTEXTUAL | P0 practical resource. |
| Retrieval | `/free-mcqs/general` | general ophthalmology free MCQs | BODY_CONTEXTUAL | Existing specific free-MCQ route. |

**Inbound opportunities:** `/exams/dnb` beneath the theory overview; `/osce` in a theory-to-viva bridge; `/resources` near exam-planning guidance. Do not link an unpublished blog URL from any live page.

## Sources

1. [NBEMS DNB/DrNB Final examinations](https://natboard.edu.in/viewnbeexam?exam=dnb) — primary live hub for sessions, bulletins, notices, old-question-paper route and the two-stage theory/practical framework; checked 18 August 2026.
2. [DNB Final June 2026 Information Bulletin](https://nbe.edu.in/IB/DNB_Final_June_2026_Information_Bulletin%2023.04.2026-V1.pdf) — primary session-specific rules document; read the bulletin for the candidate’s own session before acting.
3. [NBEMS DNB Broad Specialty](https://natboard.edu.in/dnbbroad) — primary training and final-examination context; checked 18 August 2026.

## QA

**Factuality 5/5:** all exam-process claims are bound to NBEMS; no unsupported paper count, marks, pass rule or topic frequency. **Search Intent 5/5:** explains current-source hierarchy, paper finding and analysis workflow. **Reader Value 5/5:** gives a reproducible coding scheme, answer architecture and four-week plan. **Information Gain 5/5:** corrects the false precision of unsupported “10-year analysis” claims. **Competitive Superiority 4/5:** primary-source-led method exceeds recall-list summaries. **SEO 5/5:** direct exact-query answer and descriptive structure. **GEO 5/5:** tables, visible source ledger and clear distinctions. **Naturalness 5/5:** practical PG-level tone. **E-E-A-T 5/5:** no fabricated data or experience. **Experience Integrity 5/5:** no invented candidate outcomes. **Internal Linking 5/5:** four verified `.org` routes only; no blog URL. **Conversion 4/5:** product is optional and disclosed as non-NBEMS. **Freshness 4/5:** session facts were checked 18 August 2026 and require a publication-day NBEMS review.
