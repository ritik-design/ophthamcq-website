...
1. Underline the requested quantity. Is the stem asking for power, vergence, image position, prism or a change in correction?
2. Copy only the relevant values, with units.
3. State the sign convention before substituting numbers.
4. Choose one equation; do not combine remembered fragments.
5. Calculate slowly enough to preserve the sign.
6. Check magnitude and direction against a sketch or basic physical intuition.
7. Label the error type if wrong: knowledge, setup, sign, unit, arithmetic or reading.
...
- [International Council of Ophthalmology: ICO Examinations](https://icoph.org/ico-examination/) — official operational source; checked 18 August 2026.
- [International Council of Ophthalmology: types of ICO examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) — use for current route terminology.
- [International Council of Ophthalmology: examination contact](https://icoph.org/ico-examination/contact-ico-exams/) — use where current candidate instructions need clarification.
...
|---|---|---|---|---|
| Resources | /exams/ico-fico | ICO / FICO preparation guide | BODY_CONTEXTUAL | Exam pillar |
| Resources | /free-mcqs/ico-fico | free ICO/FICO sample questions | BODY_CONTEXTUAL | Relevant free practice |
| Resources | /products/ico-optics-refraction-mcqs-part-a | ICO Optics & Refraction MCQs Part A | BODY_CONTEXTUAL | Relevant P1 product |
| Resources | /products/optics-notes | Optics & Refraction Exam Ready Notes | BODY_CONTEXTUAL | Relevant P1 product |
| Resources | /glossary | ophthalmology glossary | BODY_CONTEXTUAL | Definition support |

**Inbound opportunities:** `/exams/ico-fico`, `/resources`, and `/products/optics-notes` can link to this article once it is live. **Lateral blog links:** NO_LINK until blog routes are verified.

## QA

Factuality 5/5 — volatile exam facts deferred to ICO; Search intent 5/5 — paper-specific study route; Reader value 5/5 — calculation and error workflow; Information gain 5/5 — explicit error taxonomy; SEO 5/5; GEO 5/5 — direct answer and tables; Naturalness 4/5; E-E-A-T 4/5 — official source and named textbook; Experience integrity 5/5 — no fabricated experience; Internal linking 5/5 — inventory-verified only; Conversion 4/5 — scoped resource handoff; Freshness 5/5 — checked date and update boundary.
