...
primary_keyword: "ophthalmic sutures viva"
target_page: "/osce"
...
That sentence is better than “absorbable sutures are for internal tissue and non-absorbable sutures are for everything else.” The [2026 peer-reviewed study of ophthalmic Vicryl, nylon and polypropylene](https://pmc.ncbi.nlm.nih.gov/articles/PMC12948097/) illustrates why over-simplification fails: it examines behaviour by material, diameter and straight, knotted or looped configuration rather than treating the word absorbable as a full mechanical description.
...
1. **Swage**: the attachment end where the suture is fixed to the needle.
2. **Body**: the portion held by the needle holder; its cross-section and curvature affect control and passage.
3. **Curvature**: commonly stated as a fraction of a circle, such as 1/4, 3/8 or 1/2 circle, depending on the supplied needle.
4. **Point**: the penetrating tip, described by its geometry rather than by a guessed operation.

Most sutures used in ophthalmic surgery are mounted on curved needles, as [Community Eye Health's training article on passing sutures](https://pmc.ncbi.nlm.nih.gov/articles/PMC10762700/) notes. The curve is useful in a confined operating field, but do not say a particular curve is mandatory for a named surgery unless it is specified by the packet or the examiner. Needle-holder loading and needle passage are supervised practical skills, not something an article should turn into a step-by-step instruction.
...
1. [Experimental investigation of tensile properties and fracture behavior of ophthalmic sutures: Vicryl, nylon and polypropylene](https://pmc.ncbi.nlm.nih.gov/articles/PMC12948097/) — ophthalmic material identity, structural classification and configuration-dependent mechanical context; checked 18 August 2026.
2. [Community Eye Health: Passing sutures](https://pmc.ncbi.nlm.nih.gov/articles/PMC10762700/) — curved-needle context and supervised instrument-handling boundary; checked 18 August 2026.

## Editorial QA and link manifest

**Cannibalisation:** KEEP SEPARATE. This is a packet-first sutures-and-needles oral-reference workflow; `/products/instruments-in-ophthalmology-notes` and `/osce` remain resource/product destinations.

**Claim controls:** Source-bound classification and anatomy only. No operative sequence, procedure-specific prescription, patient-management advice, manufacturer-code invention, outcome guarantee or unsupported product feature.

| Source section | Destination | Anchor text | Anchor type | Reason | Priority |
|---|---|---|---|---|---|
| Revision close | `/products/instruments-in-ophthalmology-notes` | Instruments in Ophthalmology revision resource | descriptive | Relevant low-inbound product page | P2 |
| Revision close | `/products/instruments-drugs-practical-viva` | instruments-and-drugs practical viva resource | descriptive | Related practical resource | P2 |
| Revision close | `/topics/cataract` | cataract MCQs and study guide | semantic | Lateral surgical-revision context | P1 |
| Revision close | `/osce` | OSCE, Practical & Viva Voce Ready bundle | descriptive | Practical rehearsal hub | P0 |

**Inbound opportunities:** `/osce` in an instruments/sutures station route; `/products/instruments-in-ophthalmology-notes` beside a packet-identification use case; `/products/instruments-drugs-practical-viva` beside needle/suture revision; `/resources` in a practical-viva route. Add only if the existing sentence remains genuinely useful.

**QA vector:** Factuality 5/5 (peer-reviewed ophthalmic and training sources live-checked; material claims bounded to packet/product context); Search Intent 5/5 (materials, size, needle anatomy and oral answers); Reader Value 5/5 (packet chain, comparison tables and drill); Information Gain 5/5 (separates class, property, size and tissue-context inference); Competitive Superiority 4/5 (practical framework without unsafe procedural detail); SEO 5/5; GEO 5/5 (direct answer, tables, definitions and sources); Naturalness 5/5; E-E-A-T 4/5 (transparent source limits); Experience Integrity 5/5; Internal Linking 5/5 (all `.org` destinations verified); Conversion 4/5 (optional contextual resources); Freshness 5/5 (checked 18 August 2026; recheck before publication).
