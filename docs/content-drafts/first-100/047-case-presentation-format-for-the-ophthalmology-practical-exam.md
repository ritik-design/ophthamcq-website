...
primary_keyword: "ophthalmology case presentation format"
target_page: "/products/case-presentation-format-notes"
...
The clinical-method principle is simple: a presentation should communicate the history and examination reasoning, not reproduce the entire source record. [Clinical Methods from NCBI Bookshelf](https://www.ncbi.nlm.nih.gov/books/NBK201/) is a useful general reference for the clinical-history framework; it is not an ophthalmology practical-exam rulebook.
...
- [NCBI Bookshelf, Clinical Methods](https://www.ncbi.nlm.nih.gov/books/NBK201/)
- [American Academy of Ophthalmology education catalogue](https://www.aao.org/education/education-browse)

## Editorial QA and link manifest

- Research brief: `docs/content-research/047-case-presentation-format-serp-brief.md`; exact-query research, source ledger, fan-out and outline completed before drafting.
- Cannibalisation: KEEP SEPARATE. This is a reasoning/rehearsal guide; `/products/case-presentation-format-notes` is the product/template page.
- Scope: exam education only. No outcome guarantee, patient-specific diagnosis, treatment advice, affiliation or performance claim.
- Outbound manifest: `/products/case-presentation-format-notes` | case-presentation format resource | BODY_CONTEXTUAL/CTA | P2; `/osce` | OSCE, Practical & Viva Voce Ready bundle | BODY_CONTEXTUAL | P0; `/topics/glaucoma` | glaucoma study guide | BODY_CONTEXTUAL | P1; `/topics/cataract` | cataract study guide | BODY_CONTEXTUAL | P1; `/products/dnb-do-past-5-year-papers` | DNB / MS / DO past five-year papers | BODY_CONTEXTUAL | P1. Every route is in the content inventory and repository routes.
- Inbound opportunities: `/osce` practical preparation section; `/products/case-presentation-format-notes` supporting-guide section; `/exams/dnb` practical section; `/resources` practical-revision collection.
- QA vector: Factuality 5 (external concepts bound to sources); Search Intent 5; Reader Value 5; Information Gain 5; Competitive Superiority 5; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4 (source-led, no fabricated experience); Experience Integrity 5; Internal Linking 5; Conversion 5; Freshness 5.
