...
primary_keyword: "frcophth part 1 preparation"
secondary_keywords: ["FRCOphth Part 1 study plan", "FRCOphth Part 1 preparation", "FRCOphth Part 1 revision"]
...
1. Record why you selected the option before reading the explanation.
2. Name the discriminating feature: finding, mechanism, unit, wording or exclusion that separated the best option from the nearest distractor.
3. Schedule a retrieval task. Choose redraw, calculate, compare, explain or answer a new stem. “Read chapter again” is too vague.
...
|---|---|---|---|
| `/exams/frcophth` | FRCOphth preparation guide | BODY_CONTEXTUAL | exam-route context |
| `/free-mcqs` | free MCQ bank | BODY_CONTEXTUAL | short retrieval practice |
| `/notes` | Handwritten Exam Ready Notes | BODY_CONTEXTUAL | optional compact revision resource |
| `/products/frcophth-step-1-mcqs` | FRCOphth Step 1 MCQs | CTA | optional relevant practice route |

**Inbound opportunities:** `/exams/frcophth` beside Part 1 preparation advice; `/free-mcqs` beside study-method guidance; `/products/frcophth-step-1-mcqs` where independent question practice is described. **Lateral links:** add only after blog URLs are live and sitemap-verified.

## Sources

1. [Royal College of Ophthalmologists: Part 1 FRCOphth exam](https://www.rcophth.ac.uk/exams/rcophth-exams/part-1-frcophth-exam/) — eligibility, structure, attempts and marking; checked 18 August 2026.
2. [Royal College of Ophthalmologists: exams calendar](https://www.rcophth.ac.uk/examinations/) — application, sitting and result dates; checked 18 August 2026.
3. [RCOphth curriculum: examinations](https://curriculum.rcophth.ac.uk/curriculum/ost/assessments/examinations/) — curriculum assessment context; checked 18 August 2026.
4. [Part 1 FRCOphth information pack](https://www.rcophth.ac.uk/wp-content/uploads/2026/06/2025-Part-1-FRCOphth-Information-Pack-2.pdf) — supporting official information, labelled 2025; newer instructions take precedence.

## QA

**Factuality 5/5:** operational facts are bound to RCOphth; planning guidance is clearly framed as a framework. **Search intent 5/5:** answers the six-month-plan query. **Reader value 5/5:** capacity bands, error taxonomy and mock-debrief grid make the plan usable. **Information gain 5/5:** separates official rules from third-party weightage. **Competitive superiority 5/5:** rota-resilient feedback loop. **SEO 5/5:** direct answer and precise hierarchy. **GEO 5/5:** extractable tables and visible sources. **Naturalness 5/5:** doctor-to-doctor, no filler. **E-E-A-T 4/5:** official exam sources; no fabricated experience. **Experience integrity 5/5:** no outcome claims. **Internal linking 5/5:** repo-verified routes only. **Conversion 4/5:** optional product context is secondary. **Freshness 4/5:** official pages checked 18 August 2026; final pre-publication recheck required.
