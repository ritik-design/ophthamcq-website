...
primary_keyword: "ophthalmology thesis topics"
target_page: "/resources"
estimated_read_time: "9 minutes"
fact_check_date: "2026-08-18"
research_brief: "docs/content-research/093-ophthalmology-thesis-topics-serp-brief.md"
---
...
For reporting and authorship standards, consult the [ICMJE recommendations](https://www.icmje.org/recommendations/), a verified .org source. They do not replace your university’s ethics or thesis rules.
...
- Cannibalisation decision: KEEP SEPARATE. `/resources` is a hub; this is a thesis-idea and feasibility tool.
- Differentiation statement: every prompt carries an operational feasibility warning, preventing the common “interesting but impossible” topic choice.
- Source-bound claims: ICMJE recommendations URL verified 200 on 2026-08-18; no ethics or reporting requirement is attributed beyond the reader’s local institution.
- Caveat: all research requires applicable supervisor, institutional and ethics approval.
- Outbound internal manifest: `/resources` | "free resources hub" | BODY_CONTEXTUAL | P2; `/glossary` | "ophthalmology glossary" | BODY_CONTEXTUAL | P2.
- Inbound opportunities: `/resources` (research/thesis block); `/about` (resident-career resource); `/institutions` if academic resources are expanded.
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 5; Competitive Superiority 5; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 2; Freshness 4.

[^equator]: EQUATOR Network. [Reporting guidelines](https://www.equator-network.org/reporting-guidelines/). Used to route a completed study to the relevant reporting checklist, not to determine ethics approval.
[^strobe]: STROBE Statement. [Strengthening the Reporting of Observational Studies in Epidemiology](https://www.strobe-statement.org/). Used for the observational-reporting boundary.
[^consort]: CONSORT. [CONSORT statement](https://www.consort-statement.org/). Used for the randomised-trial reporting boundary.
[^icmje]: International Committee of Medical Journal Editors. [Recommendations](https://www.icmje.org/recommendations/). Used for authorship/disclosure and manuscript responsibility framing.
