...
The [National Medical Commission](https://www.nmc.org.in/) is the national regulator’s public gateway for regulatory context. It is not a substitute for the university’s final-examination notice. Similarly, [NBEMS](https://natboard.edu.in/) is relevant when you are checking a DNB rule, but it does not set a university DO paper. Keep these pathways separate.
...
1. **Retrieve:** write or speak one answer from memory in the time your local paper permits.
2. **Check:** compare it against the prescribed/standard source and mark omissions, sequencing failures and unsupported statements separately.
3. **Repair:** make five to ten prompts from the missed concepts, then repeat the answer 48 hours later without looking.
...
Do not respond by collecting more generic material. Take a short, specific question to the
department: “For the final practical, which cases, records, instruments and investigation
descriptions should we be prepared to demonstrate, and where is the current instruction
published?” Follow it with a written list of the answer and date. This is an administrative
clarification, not an attempt to obtain predicted questions. It protects you from rehearsing a
format that a local circular has already replaced.

When faculty give a revision suggestion, preserve its status. Mark it as departmental teaching
advice, not as a university rule, unless it appears in the official document. That keeps a useful
tip useful without allowing it to masquerade as an examination requirement.

## Sources

- [National Medical Commission](https://www.nmc.org.in/) — regulatory gateway; check the relevant current document for any regulatory question.
- [National Board of Examinations in Medical Sciences](https://natboard.edu.in/) — DNB-specific information only.
...
- [OphthaMCQ DNB / MS / DO guide](https://ophthamcq.org/exams/dnb) — on-site revision route.
- [OphthaMCQ OSCE, Practical & Viva Voce Ready](https://ophthamcq.org/osce) — on-site practical preparation route.

## Editorial QA and link manifest

**Claim control:** no universal DO paper pattern, pass mark, eligibility, practical station, recognition or career entitlement is asserted. Independent factual claims are bound to the named authority; study methods are presented as editorial guidance. No patient advice or outcome guarantee.

| Source section | Destination | Anchor | Type | Reason | Priority |
|---|---|---|---|---|---|
| Practical rehearsal | `/osce` | OSCE, Practical & Viva Voce Ready | BODY_CONTEXTUAL | practical preparation route | P0 |
| Past-question method | `/products/dnb-do-past-5-year-papers` | DNB / DO Past 5-Year Papers | BODY_CONTEXTUAL | relevant product page/orphan support | P1 |
| DO versus DNB | `/exams/dnb` | DNB / MS / DO preparation guide | BODY_CONTEXTUAL | broad preparation hub | P0 |

**Inbound opportunities after publication:** `/exams/dnb` (DO final-exam workflow), `/osce` (university-format practical rehearsal), and `/resources` (document-first study planning). Add only after the blog slug is live and verified in the sitemap.

**QA vector:** Factuality 5/5 (local authority boundary explicit); Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5 (source-led, no invented experience); Experience Integrity 5/5; Internal Linking 5/5; Conversion 4/5; Freshness 4/5 (recheck local circular at publication).
