---
title: "Kanski vs BCSC vs Khurana: Which One for Which Exam?"
proposed_slug: "kanski-vs-bcsc-vs-khurana-which-one-for-which-exam"
meta_description: "Choose Kanski, BCSC or Khurana by exam task, weak area and time available. A practical reading stack for ophthalmology PG residents."
excerpt: "Kanski, BCSC and Khurana do different jobs. Select the next chapter by the gap your examination exposes, not by a universal book ranking."
category: "Resources"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "longform-researched-draft"
primary_keyword: "kanski vs bcsc"
...
The [publisher page for Kanski’s *Clinical Ophthalmology*](https://www.us.elsevierhealth.com/kanskis-clinical-ophthalmology-9780702085720.html) is the appropriate bibliographic source for the book’s broad clinical scope. The AAO’s [guidance on using BCSC](https://www.aao.org/young-ophthalmologists/yo-info/article/4-tips-prep-okap-with-bcsc) confirms the series as a section-based learning resource. Neither source says that a book is the right answer for every examination.

## First decide what your exam is actually testing

Before comparing covers, write down the next assessment and its output. A university theory paper may reward a structured explanation, diagrams and breadth. A DNB candidate may be allocating time between theory, practical preparation and ongoing clinical work. An ICO / FICO or FRCOphth candidate needs to map study to the applicable current official information, not to assume that an American series or a UK-favoured title is automatically prescribed. The [ICO education gateway](https://icoph.org/education/) and [RCOphth curriculum gateway](https://www.rcophth.ac.uk/curriculum/) are places to begin that check; they are more authoritative for their own requirements than a bookstore list.
...
1. **Ten minutes: name the gap.** Copy one missed question or a viva prompt into an error log. State why the distractor attracted you.
2. **Thirty minutes: read one bounded section.** Use Kanski for clinical connections, BCSC for a narrow mechanism, or Khurana for the first framework. Stop when the named question is answered.
3. **Fifteen minutes: produce an output.** Draw a pathway, build a differential table, solve three calculations, or speak a 60-second answer.
4. **Fifteen minutes: retrieve.** Attempt fresh questions or repeat the explanation without the text. Mark uncertainty precisely.
5. **Five minutes: schedule the return.** Re-test after 48–72 hours in a mixed set. If the weakness survives, escalate to the other resource type; if it does not, move on.
...
- [Elsevier: *Kanski’s Clinical Ophthalmology*](https://www.us.elsevierhealth.com/kanskis-clinical-ophthalmology-9780702085720.html) — publisher bibliographic source for the broad clinical reference; checked 18 August 2026.
- [American Academy of Ophthalmology: using BCSC for exam study](https://www.aao.org/young-ophthalmologists/yo-info/article/4-tips-prep-okap-with-bcsc) — AAO education guidance on active, section-based use; checked 18 August 2026.
- [International Council of Ophthalmology: education](https://icoph.org/education/) — official gateway for current ICO education and examination information; checked 18 August 2026.
...
- **Cannibalisation:** KEEP SEPARATE from article 61. Article 61 chooses a complete PG reading stack; this page resolves the narrower Kanski-versus-BCSC-versus-Khurana decision by study task.
- **Differentiation:** a failure-type selector, exam-specific usage boundaries and a 75-minute read–produce–retrieve loop replace a false universal winner.
- **Claim boundary:** education for postgraduate doctors only. No medical advice, pass claim, official-list claim, edition/year/price assertion or implied endorsement.
- **Outbound internal manifest:**

| Source section | Destination | Anchor | Type | Priority | Reason |
|---|---|---|---|---|---|
| DNB / MS / DO | `/exams/dnb` | DNB Ophthalmology preparation guide | BODY_CONTEXTUAL | P0 | Exam planning route |
| DNB / MS / DO | `/free-mcqs/general` | general ophthalmology free MCQs | BODY_CONTEXTUAL | P2 | Retrieval-practice complement |
| Practical preparation | `/osce` | OSCE, Practical & Viva Voce Ready | BODY_CONTEXTUAL | P0 | Practical revision route |
| ICO / FICO | `/exams/ico-fico` | ICO / FICO preparation guide | BODY_CONTEXTUAL | P0 | Relevant exam route |
| ICO / FICO | `/free-mcqs/ico-fico` | ICO / FICO sample questions | BODY_CONTEXTUAL | P1 | Exam-specific retrieval |
| ICO / FICO | `/products/ico-fico-past-papers` | ICO/FICO Past Papers | BODY_CONTEXTUAL | P0 | Sample-page/product route |
| FRCOphth | `/exams/frcophth` | FRCOphth preparation guide | BODY_CONTEXTUAL | P0 | Relevant exam route |
| FRCOphth | `/products/frcophth-step-1-mcqs` | FRCOphth Step 1 MCQs | BODY_CONTEXTUAL | P1 | Remediates zero-inbound product page |
| Revision | `/notes` | Handwritten Exam Ready Notes | BODY_CONTEXTUAL | P0 | Concise revision layer, no replacement claim |

- **Inbound opportunities:** `/resources` beside the study-resource selector; `/faq` in any reference-material answer; `/exams/dnb`, `/exams/ico-fico` and `/exams/frcophth` in study-method sections; `/compare/best-ophthalmology-question-banks` only where readers are choosing question practice rather than textbooks. Add after this article has a final live URL in the sitemap.
- **QA vector:** Factuality 5/5 (publisher and official-body sources bound to claims); Search Intent 5/5 (direct comparison decision answered); Reader Value 5/5 (task matrix, failure selector and usable study loop); Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5 (all routes verified in inventory); Conversion 4/5; Freshness 4/5 (edition and examination information require final check).
