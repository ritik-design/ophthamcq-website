...
primary_keyword: "pediatric ophthalmology mcq"
secondary_keywords: ["squint MCQs", "strabismus MCQs with answers", "paediatric ophthalmology questions"]
target_page: "/topics/pediatric-ophthalmology"
...
1. **What is the first diagnostic concern in a child with leukocoria?**  
   ...
   **Why:** Leukocoria has a differential, including cataract and persistent fetal vasculature, but the examination-safe red-flag response is to exclude a sight- and life-threatening intraocular tumour rather than reassure from a photograph alone.[^aapos]
...
5. **Amblyopia is best defined as what?**  
   ...
   **Why:** First establish the best credible, age-appropriate acuity and exclude pathology; a poorly cooperative child is not automatically amblyopic.[^aapos]
...
12. **A tropia is what kind of deviation?**  
   **Answer:** Manifest.  
...
13. **Which test detects a manifest deviation?**  
   **Answer:** The cover–uncover test.  
   **Why:** Cover one eye and watch the *uncovered* eye for a refixation movement. The direction of that movement identifies the manifest deviation being controlled by fusion.[^strab]

14. **What does the alternate cover test do differently?**  
...
15. **The Hirschberg test estimates deviation from what?**  
...
16. **A child appears esotropic because of epicanthal folds, yet corneal reflexes and cover test are normal. What is this called?**  
   **Answer:** Pseudostrabismus.  
   **Why:** Appearance is not alignment. The question tests why objective testing matters before giving reassurance.[^aapos]

17. **Esotropia means what?**  
...
18. **What refractive state is classically associated with accommodative esotropia?**  
   **Answer:** Hyperopia.  
...
19. **Why is an abnormal head posture valuable in a squint stem?**  
...
20. **What does an abduction deficit with an esodeviation make you consider?**  
...
21. **The Parks three-step test is traditionally used to help localise what?**  
...
22. **Does a freely alternating deviation carry the same amblyopia implication as a constant unilateral deviation?**  
...
23. **Infantile esotropia is conventionally described as onset when?**  
...
24. **A new, acute-onset squint with neurological symptoms should be framed how?**  
...
25. **What is the classic symptom triad in primary congenital glaucoma?**  
   **Answer:** Epiphora, photophobia and blepharospasm.  
   **Why:** Corneal enlargement/clouding and globe enlargement may support the picture. The triad is an association, not a reason to ignore other causes of tearing or photophobia.[^pcg]

26. **Why can buphthalmos occur in early childhood glaucoma?**  
...
27. **Haab striae are breaks in which layer?**  
...
28. **Why is an age-appropriate visual assessment essential in every paediatric station?**  
...
29. **Marcus Gunn jaw-winking ptosis is an example of what?**  
   **Answer:** Synkinesis.  
...
30. **Why is a child with strabismus and leukocoria not simply an “amblyopia” case?**  
...
31. **ROP is a disorder of what developmental process?**  
   **Answer:** Retinal vascular development in preterm infants.  
   **Why:** Screening is a serial programme for eligible infants, not a single fundus examination. Eligibility and timing are programme-specific and must be checked locally.[^icrop]

32. **What does ROP zone describe?**  
...
36. **What do stages 4 and 5 ROP represent?**  
...
37. **What are the posterior-pole vascular features of plus disease?**  
   **Answer:** Venous dilatation and arteriolar tortuosity.  
   **Why:** Plus disease is a severity modifier. In a formal description, combine zone, stage, extent and plus status.[^icrop]

38. **How should extent of ROP be documented?**  
...
39. **Why is it unsafe to quote a universal ROP screening birth-weight or timing cut-off without context?**  
   **Answer:** Eligibility, timing and follow-up intervals differ between current national and unit programmes.  
   **Why:** ICROP classifies disease; it does not prescribe one global screening schedule. In an exam, answer the guideline named in the stem.[^icrop]

40. **Give the safest one-sentence ROP examination description.**  
...
- **Cannibalisation:** KEEP SEPARATE from queue 041 and `/topics/pediatric-ophthalmology`. Queue 041 explains screening/protocol boundaries; this is a 40-question retrieval set spanning red flags, alignment and ROP classification.
- **Differentiation:** questions force the reader to identify the decision layer before recalling the label, especially in leukocoria and ROP stems.
- **Outbound internal links:** `/topics/pediatric-ophthalmology`, `/free-mcqs`, `/osce` — verified repository routes.
- **Inbound opportunities after publication:** `/topics/pediatric-ophthalmology`, `/free-mcqs`, `/resources`, `/osce`.
- **Claim check:** educational revision only; no individual clinical recommendation, universal ROP screening threshold, exam-outcome promise or unsupported product claim.
- **Gate result:** factuality 5/5; search intent 5/5; reader value 5/5; information gain 4/5; SEO 5/5; GEO 5/5; naturalness 5/5; experience integrity 5/5; internal linking 5/5; conversion 3/5; freshness 4/5.

[^aapos]: American Association for Pediatric Ophthalmology and Strabismus. [Vision screening and amblyopia resources](https://aapos.org/glossary/amblyopia) and [Leukocoria](https://aapos.org/glossary/leukocoria). Used for the paediatric assessment/red-flag framework.
[^strab]: American Association for Pediatric Ophthalmology and Strabismus. [Strabismus glossary](https://aapos.org/glossary/strabismus). Used for alignment terminology and examination concepts.
[^pcg]: American Academy of Ophthalmology EyeWiki. [Primary congenital glaucoma](https://eyewiki.org/Primary_Congenital_Glaucoma). Used for congenital-glaucoma examination associations.
[^icrop]: Chiang MF, et al. [International Classification of Retinopathy of Prematurity, Third Edition (ICROP3)](https://pubmed.ncbi.nlm.nih.gov/35500455/). Used for ROP terminology and structured description; screening eligibility remains programme-specific.
