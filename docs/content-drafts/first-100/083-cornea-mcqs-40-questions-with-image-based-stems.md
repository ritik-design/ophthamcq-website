---
title: "Cornea MCQs: 40 Text-First Image-Pattern Questions"
proposed_slug: "cornea-mcqs-40-questions-with-image-based-stems"
meta_description: "40 cornea MCQs with worked, text-first image-pattern stems for PG revision: layers, keratitis, dystrophies, ectasia and grafts."
excerpt: "Before naming the disease, state the site, layer, pattern, stain and associated sign."
category: "Free MCQs"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "reviewed-draft"
primary_keyword: "cornea mcq questions"
target_page: "/topics/cornea"
...
| If the stem says … | First classification | Common overcall to avoid |
|---|---|---|
| Terminal bulbs vs pseudodendrite | HSV dendrite vs zoster-associated pseudodendrite pattern | Calling all branching lesions HSV |
| Ring infiltrate, pain and water/lens context | Acanthamoeba differential | Treating a ring as diagnostic |
| Guttae vs stromal deposits vs epithelial map-dot pattern | Endothelial vs stromal vs epithelial-basement-membrane layer | Calling every opacity a stromal dystrophy |
| PK, DALK, DSAEK, DMEK | Graft tissue plane | Choosing a graft from an eponym alone |
...
1. [AAO: Bacterial Keratitis Preferred Practice Pattern](https://www.aaojournal.org/article/S0161-6420(23)00707-7/fulltext) — ulcer assessment and microbial-keratitis framework.
2. [Bacterial Keratitis, StatPearls](https://www.ncbi.nlm.nih.gov/books/NBK574509/) — examination and descriptive terminology.
3. [Acanthamoeba keratitis review](https://pubmed.ncbi.nlm.nih.gov/30601984/) — classic signs and their limitations.
4. [IC3D Classification of Corneal Dystrophies, Edition 3](https://pubmed.ncbi.nlm.nih.gov/31609849/) — dystrophy classification and terminology.
5. [Fuchs Endothelial Corneal Dystrophy, GeneReviews](https://www.ncbi.nlm.nih.gov/books/NBK1190/) — endothelial-dystrophy phenotype context.
6. [Deep anterior lamellar keratoplasty review](https://pubmed.ncbi.nlm.nih.gov/29635194/) — DALK tissue plane.
7. [DMEK review](https://pubmed.ncbi.nlm.nih.gov/25569353/) — DMEK graft composition.

## Editorial QA and internal-link manifest

- **Cannibalisation:** KEEP SEPARATE from `/topics/cornea`; the topic page is a broad guide, while this draft is a text-first, answer-explained quiz. The requested image intent is served without embedding uncleared clinical images.
- **Differentiation:** every pattern stem begins with morphology and layer, and classic signs are explicitly bounded so a candidate does not treat them as diagnostic alone.
- **Claim review:** all independent clinical-education claims are source-bound above. No patient instruction, pass guarantee, product-learning claim, competitor claim or unverified company statistic.
- **Outbound links:** `/topics/cornea` (cornea study guide; BODY_CONTEXTUAL, P1); `/free-mcqs/general` (mixed recall; BODY_CONTEXTUAL, P2); `/notes` (notes collection; BODY_CONTEXTUAL, P0). All are verified inventory routes.
- **Inbound opportunities:** `/topics/cornea` (“cornea image-pattern MCQs”); `/free-mcqs` (“40 cornea MCQs”); `/resources` (“text-first cornea quiz”); `/notes` (“cornea MCQ revision”). Add only after theStacc publishes and exposes the final article URL.
- **Gate result:** factuality 5/5; search intent 5/5; reader value 5/5; information gain 5/5; SEO 5/5; GEO 5/5; naturalness 5/5; experience integrity 5/5; internal linking 5/5; conversion 4/5; freshness 4/5.
