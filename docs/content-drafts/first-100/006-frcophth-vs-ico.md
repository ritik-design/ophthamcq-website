...
| Decision | Correct authority | Why online comparisons are weak evidence |
|---|---|---|
| What does the examination assess and require? | RCOphth or ICO | Only the examining body can confirm current components, prerequisites, fees and dates. |
| Can I register to practise in a named country? | The named regulator | Registration rules may require much more than an exam pass. |
| Will I be eligible or competitive for a named post? | Employer, deanery or programme | Person specifications and recruitment decisions belong to the employer. |
| Can I travel or work there? | Relevant immigration authority | An examination certificate does not determine immigration status. |
...
The [RCOphth examinations hub](https://www.rcophth.ac.uk/examinations/) presents FRCOphth as a multi-component route: Part 1 FRCOphth, the Refraction Certificate, Part 2 FRCOphth Written and Part 2 FRCOphth Oral. RCOphth states that Part 2 Written follows a Part 1 pass; Part 2 Oral requires Part 1, the Refraction Certificate and Part 2 Written.
...
| Lens | FRCOphth | ICO | What you should verify yourself |
|---|---|---|---|
| Examining body | The Royal College of Ophthalmologists | International Council of Ophthalmology | The live component page, not a reseller’s summary. |
| Published progression | Part 1 → Refraction Certificate → Part 2 Written → Part 2 Oral, with stated prerequisites | Standard areas include Visual Sciences, Optics/Refraction/ Instruments, and Clinical Ophthalmology; Advanced has further conditions | Whether a prior qualification meets any recognised-equivalent wording. |
| Immediate study framing | Curriculum and component blueprint | Paper-specific Standard sequence | The current syllabus, format and candidate instructions. |
| Logistics | Component/diet dependent | ICO publishes examination dates, registration and centre information | Current dates, location/delivery, fees, identity and closing date. |
| Career interpretation | A qualification route administered by RCOphth | An international examination route administered by ICO | What a named regulator, employer or programme accepts for your purpose. |
...
If your goal involves UK registration, open the [GMC registration information](https://www.gmc-uk.org/registration-and-licensing/join-the-register) and the exact route relevant to you. If your goal involves a job, fellowship or training place, read the programme’s current person specification or ask its recruitment contact. Phrase the question precisely: *Does [named examination/part] meet the stated requirement for [named route/post], and what additional evidence is required?*
...
- [The Royal College of Ophthalmologists: Examinations](https://www.rcophth.ac.uk/examinations/) — FRCOphth pathway, components, live dates and fee location; checked 18 August 2026.
- [The Royal College of Ophthalmologists: Part 1 FRCOphth](https://www.rcophth.ac.uk/examinations/part-1-frcophth/) — example component-specific entry and application rules; checked 18 August 2026.
- [International Council of Ophthalmology: ICO Examinations](https://icoph.org/ico-examination/) — Standard/Advanced pathway and live examination information; checked 18 August 2026.
- [International Council of Ophthalmology: Type of ICO Examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) — Standard areas, component dependencies and FICO condition; checked 18 August 2026.
- [General Medical Council: registration and licensing](https://www.gmc-uk.org/registration-and-licensing/join-the-register) — separate registration authority context; checked 18 August 2026.

## Internal-link manifest

| Source section | Destination | Anchor | Type | Reason | Priority |
|---|---|---|---|---|---|
| FRCOphth route | /exams/frcophth | FRCOphth guide | BODY_CONTEXTUAL | Relevant route hub | P0 |
| ICO route | /exams/ico-fico | ICO / FICO guide | BODY_CONTEXTUAL | Relevant route hub | P0 |
| Diagnostic | /free-mcqs/frcophth | try free FRCOphth MCQs | BODY_CONTEXTUAL | Useful low-commitment practice | P1 |
| Diagnostic | /free-mcqs/ico-fico | practise ICO/FICO-style free MCQs | BODY_CONTEXTUAL | Useful low-commitment practice | P1 |
| Final navigation | /exams | ophthalmology examinations hub | BODY_CONTEXTUAL | Primary comparison target | P0 |

**Inbound opportunities:** `/exams` comparison/selection block; `/exams/frcophth` “is this route for me?” block; `/exams/ico-fico` sequence block; `/resources` international exam planning page. Do not link from unpublished blog drafts.

## QA

Factuality 5/5 — route statements are bound to RCOphth/ICO primary sources; no volatile fee or recognition claim. Search Intent 5/5 — answers the real selection question rather than ranking badges. Reader Value 5/5 — authority map, comparison table, decision tree and next-week plan. Information Gain 5/5 — separates credential, regulation and employment decisions. Competitive Superiority 4/5 — avoids generic “which is easier” content and gives a verification method. SEO 5/5; GEO 5/5; Naturalness 5/5. E-E-A-T 5/5 — source-led and independently framed. Experience Integrity 5/5 — no invented testimonials/outcomes. Internal Linking 5/5 — verified contextual links only. Conversion 4/5 — helpful practice links without product pressure. Freshness 5/5 — fact-check date and live-source protocol.
