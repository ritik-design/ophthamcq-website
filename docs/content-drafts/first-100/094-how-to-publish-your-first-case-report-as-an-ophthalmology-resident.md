...
primary_keyword: "ophthalmology case report publishing"
secondary_keywords: "ophthalmology case report checklist, care case report, ophthalmology resident publication"
...
Authorship should be discussed before the last night before submission. The [ICMJE Recommendations](https://www.icmje.org/recommendations/) are a useful gateway for current authorship and publication principles; they are not a substitute for your institution’s policy or a way to settle a local disagreement.[^3]
...
The CARE Statement and its checklist provide a reporting framework for case reports, and the CARE guideline elaboration explains why transparent case information, patient perspective where appropriate, consent and chronology matter.[^1][^2] Use the framework to find omissions; do not turn it into a claim that your report is ethically approved, complete in every setting or publishable.
...
1. Does every author approve the final version and meet the current journal/institution standard?
2. Does the consent/permission status match the journal’s required declaration and the institution’s process?
3. Are images necessary, permitted, de-identified to the required standard and captioned accurately?
4. Does the timeline match the source record, including uncertainty and follow-up?
5. Has every “first,” “novel,” causal or superiority phrase been removed or sourced and qualified?
6. Does each reference support the sentence before it?
7. Does the manuscript match the journal’s current category, word count and file instructions?
8. Are conflicts, funding, contributors and acknowledgements described as required?
...
[^1]: CARE Case Report Guidelines. [CARE Statement](https://www.care-statement.org/). Live-checked 18 August 2026.
[^2]: Gagnier JJ, Kienle G, Altman DG, et al. [The CARE guidelines: consensus-based clinical case reporting guideline development](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4548565/). *Journal of Clinical Epidemiology*. 2014. Live-checked 18 August 2026.
[^3]: International Committee of Medical Journal Editors. [Recommendations for the Conduct, Reporting, Editing, and Publication of Scholarly Work in Medical Journals](https://www.icmje.org/recommendations/). Live-checked 18 August 2026.
[^4]: EQUATOR Network. [CARE reporting guideline gateway](https://www.equator-network.org/reporting-guidelines/care/). Live-checked 18 August 2026.

## Editorial QA and link manifest

- **Cannibalisation:** KEEP SEPARATE from `/resources`; this is a detailed scholarly-writing workflow rather than a resource listing.
- **Differentiation:** Consent, evidence, authorship and search boundaries come before drafting and journal matching; the claim-to-document audit makes uncertainty visible.
- **Claim control:** No publication, acceptance, novelty, indexing, timeline, ethical/legal sufficiency, career, fellowship or patient-management promise.
- **Outbound internal links:** `/resources`, `/products/case-presentation-format-notes`, `/exams/fellowship`, `/glossary` — verified inventory/repository routes.
- **Inbound opportunities after publication:** `/resources` (academic writing), `/exams/fellowship` (portfolio preparation), `/about` (resident career resources). Add only after the theStacc URL is live in the sitemap.
- **Gate vector:** Factuality 5/5; Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5 (transparent source boundary); Experience Integrity 5/5; Internal Linking 5/5; Conversion 3/5; Freshness 4/5 (journal/local policies require final recheck).
