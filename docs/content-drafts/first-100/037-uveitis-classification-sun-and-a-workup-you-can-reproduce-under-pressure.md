...
primary_keyword: "uveitis classification mcq"
target_page: "/topics/uveitis"
...
1. **Anatomical location**: anterior, intermediate, posterior or panuveitis.
2. **Laterality**: unilateral, bilateral or alternating.
3. **Onset**: sudden or insidious.
4. **Duration**: limited or persistent.
...
- [Standardization of Uveitis Nomenclature (SUN) 2005 report, PubMed](https://pubmed.ncbi.nlm.nih.gov/16196117/) — original nomenclature, grading and course definitions.
- [SUN Working Group disease-classification publications, PubMed search](https://pubmed.ncbi.nlm.nih.gov/?term=Standardization+of+Uveitis+Nomenclature+Working+Group) — current disease-specific research-classification literature, checked 18 August 2026.
- [American Academy of Ophthalmology: Uveitis](https://www.aao.org/education) — professional education resource, accessed 18 August 2026.
- [Uveitis, StatPearls](https://www.ncbi.nlm.nih.gov/books/NBK540993/) — terminology and differential cross-check, accessed 18 August 2026.
- [International Uveitis Study Group classification, PubMed](https://pubmed.ncbi.nlm.nih.gov/15929990/) — anatomical classification context.

## Editorial QA and link manifest

- Research: exact-query SERP, sources and detailed outline in `docs/content-research/037-uveitis-sun-serp-brief.md`.
- Cannibalisation: KEEP SEPARATE from `/topics/uveitis`; this is classification/workup reasoning, not a broad disease guide.
- Verified outbound internal URLs: `/topics/uveitis`, `/free-mcqs`.
- Inbound opportunities: `/topics/uveitis`, `/free-mcqs/general`, `/resources`, `/osce`.
- Claim checks: clinical education only; no patient-specific treatment, no guaranteed exam outcome, no unsupported association claims.
