...
Before buying a course, booking travel or changing your rotation calendar, create a dated folder containing the material for your intended sitting. Start at [ICO Examinations](https://icoph.org/ico-examination/), then consult the official [types of ICO examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) page and candidate material currently linked there. Use the [ICO examination contact page](https://icoph.org/ico-examination/contact-ico-exams/) if an eligibility or route point is unclear.

Record the answer and the source date for each question below:

| Verify | Why it changes your plan |
|---|---|
| Exact examination or credential name | prevents mixing BVS, paper names and fellowship terminology |
| Eligibility and documents | avoids discovering a missing prerequisite late |
| Components still required for you | turns “study FICO” into a real paper sequence |
| Dates, centres and deadlines | determines the available study window |
| Format, permitted materials and candidate instructions | determines practice conditions |
| Fees and refund/deferral terms | prevents financial assumptions |
| Award conditions and terminology | avoids inaccurate CV or application wording |
...
| Phase | Weeks | Output |
|---|---:|---|
| Audit | 1 | official verification folder, coverage map, baseline mixed set |
| Rebuild | 2–4 | targeted concept repair and one-page error log per weak domain |
| Integrate | 5–8 | mixed question blocks, image review and timed decision practice |
| Simulate | 9–10 | practice under the current candidate instructions for your sitting |
| Polish | 11–12 | retest error cards, update administrative checklist, protect sleep and logistics |
...
- [International Council of Ophthalmology: ICO Examinations](https://icoph.org/ico-examination/) — official source for current operational information; checked 18 August 2026.
- [International Council of Ophthalmology: types of ICO examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) — check current route terminology and candidate information.
- [International Council of Ophthalmology: contact ICO examinations](https://icoph.org/ico-examination/contact-ico-exams/) — use for unresolved current requirements.
- Bowling B. *Kanski's Clinical Ophthalmology*; American Academy of Ophthalmology. *Basic and Clinical Science Course*. Use current editions for study, not for changing ICO administration.

## Internal-link manifest

| Source section | Destination | Anchor | Type | Reason |
|---|---|---|---|---|
| Resources | /exams/ico-fico | ICO / FICO preparation guide | BODY_CONTEXTUAL | Primary hub |
| Resources | /free-mcqs/ico-fico | free ICO/FICO sample questions | BODY_CONTEXTUAL | Relevant free practice |
| Past-paper method | /products/ico-fico-past-papers | ICO/FICO Past Papers | BODY_CONTEXTUAL | P0 product support |
| Resources | /products/ico-basic-visual-sciences | ICO Basic Visual Sciences MCQs | BODY_CONTEXTUAL | BVS support |
| Resources | /products/ico-optics-refraction-mcqs-part-a | ICO Optics & Refraction MCQs Part A | BODY_CONTEXTUAL | Optics support |

**Inbound opportunities:** `/exams/ico-fico`, `/resources`, `/products/ico-fico-past-papers`, `/products/ico-basic-visual-sciences`. **Lateral blog links:** NO_LINK until a live sitemap verifies the destination.

## QA

Factuality 5/5 — no frozen eligibility, fees, sequence or scoring claims; Search intent 5/5; Reader value 5/5 — verification and 12-week system; Information gain 5/5; SEO 5/5; GEO 5/5; Naturalness 4/5; E-E-A-T 4/5; Experience integrity 5/5 — no invented outcome/experience; Internal linking 5/5 — verified inventory URLs; Conversion 4/5; Freshness 5/5.
