...
primary_keyword: "ffa interpretation ophthalmology"
...
The AAO’s angiography education materials are useful for revising the modality distinction.[^1][^2] In a timed answer, avoid false precision about a phase occurring at an identical number of seconds in every study. State the sequence and phase shown; acquisition technique and circulation vary.
...
1. **Hyperfluorescence equals leakage.** False: transmission, pooling and staining are alternatives.
2. **Late brightness proves active disease.** False: staining can be late and bright with stable margins.
3. **Every dark area is non-perfusion.** False: blood, pigment and exudate can block fluorescence.
4. **Window defect equals RPE leakage.** False: it reflects increased transmission through reduced RPE pigment.
5. **Pooling and leakage are interchangeable.** False: pooling is constrained by a defined anatomic space.
6. **ICGA is “FFA but deeper.”** Too crude. State its near-infrared, choroidal-information role.
7. **One angiogram image confirms a final diagnosis.** Unsafe. The phase series and clinical context matter.
...
[^1]: [American Academy of Ophthalmology: Fluorescein Angiography](https://www.aao.org/education/disease-review/fluorescein-angiography)
[^2]: [American Academy of Ophthalmology: Indocyanine Green Angiography](https://www.aao.org/education/disease-review/indocyanine-green-angiography)
[^3]: [International PCV Study Group report](https://pubmed.ncbi.nlm.nih.gov/20457981/)
...
| Gate | Result |
|---|---|
| Clinical scope | Exam image-interpretation education; no patient-specific investigation/treatment direction |
| Claim binding | Angiography mechanics and disease-context claims linked to AAO/peer-reviewed sources |
| Cannibalisation | KEEP SEPARATE from `/topics/retina` and `/products/read-ophthalmology-reports-tests` |
| Outbound verified internal routes | `/topics/retina`, `/products/read-ophthalmology-reports-tests`, `/free-mcqs/high-yield`, `/glossary` |
