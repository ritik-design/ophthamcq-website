...
1. **AIOS membership.** Confirm that your membership is active and the name/profile match your documents.
2. **A recognised postgraduate ophthalmology qualification.** AIOS lists DO, DNB, MD, MS or a recognised international qualification.
3. **At least two years’ experience after postgraduate completion.** AIOS expressly states that time spent in fellowship or senior residency can be included.
4. **A subspecialty training or experience route.** AIOS lists completion of, or at least 18 months in, a subspecialty fellowship; completion of, or at least 18 months in, senior residency; or at least three years of practical work in the subspecialty.
5. **The relevant cut-off date.** For the 2026 written examination, AIOS states that requirements 3–6 are assessed as of **30 September 2026**.
...
1. State what you are looking at and its quality/limitations.
2. Name the positive finding and its location.
3. Give the leading diagnosis or interpretation.
4. Name the closest differential and the feature separating it.
5. State the next investigative or management **principle** only if the examiner asks for it.
6. Add the key complication, contraindication or follow-up issue relevant to the question.
...
|---|---|---|
| `/exams/faico` | FAICO preparation guide | Exam-route context |
| `/free-mcqs/faico` | free FAICO MCQs | Short retrieval practice |
| `/products/faico-mcqs` | FAICO MCQs | Optional product preview |

**Inbound opportunities:** `/exams/faico` beside its eligibility overview; `/products/faico-mcqs` beside a study-method link; `/resources` in a career/exam-planning section.

## Sources

- [AIOS: About FAICO, 2026 eligibility, specialties, dates, centres and fee](https://www.aios.org/article-66-about-faico.php) — checked 18 August 2026.
- [AIOS: Honourary FAICO information](https://www.aios.org/article-67-hony-faico.php) — checked 18 August 2026; included to distinguish honourary FAICO from the examined FAICO route.

## QA

Factuality **5/5** — date, fee, eligibility and pattern statements are dated and bound to AIOS. Search Intent **5/5** — directly covers eligibility, specialties, pattern, dates, centres and preparation. Reader Value **5/5** — adds a document workflow and MCQ-to-viva preparation system. Information Gain **5/5** — resolves the overlap of post-PG and route-specific requirements and flags centre inconsistency. Competitive Superiority **4/5** — current primary source; publish-day recheck required. SEO **5/5**. GEO **5/5**. Naturalness **5/5**. E-E-A-T **5/5**. Experience Integrity **5/5** — no fabricated credentials or outcomes. Internal Linking **5/5**. Conversion **4/5** — optional resource clearly labelled. Freshness **5/5** on 18 August 2026; recheck before publication.
