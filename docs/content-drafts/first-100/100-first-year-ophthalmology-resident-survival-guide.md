---
title: "First-Year Ophthalmology Resident Survival Guide"
proposed_slug: "first-year-ophthalmology-resident-survival-guide"
meta_description: "A practical first-year ophthalmology resident guide to local orientation, supervision, feedback, de-identified learning logs and a manageable study system."
excerpt: "First year is not a race to look independent. Build a repeatable loop: prepare, observe, document within the local standard, ask, and close the learning gap."
category: "Career"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "reviewed-draft"
primary_keyword: "first year ophthalmology residency"
secondary_keywords: "ophthalmology resident first year, ophthalmology residency survival guide, first-year ophthalmology study plan"
target_page: "/about"
...
1. **A repeated encounter:** an examination term, instrument, imaging pattern or clinical vocabulary item you saw more than once.
...
[^1]: World Health Organization. [WHO Patient Safety Curriculum Guide: Multi-professional Edition](https://www.who.int/publications/i/item/9789241501958). Live-checked 18 August 2026.
[^2]: American Academy of Ophthalmology. [Education catalogue](https://www.aao.org/education/education-browse). Professional-learning gateway; recheck directly before publication and use only alongside local curriculum requirements.

## Editorial QA and link manifest

- **Cannibalisation:** KEEP SEPARATE from `/about` and `/resources`; this is a role-transition and learning-system guide.
- **Differentiation:** A local-map checklist, prepare–observe–close loop, de-identified learning log, specific-feedback prompts and first-month reset avoid hidden assumptions about any one hospital.
- **Claim control:** No patient-specific clinical guidance, procedure instruction, universal curriculum, competence, exam, career, workload or clinical-safety guarantee. Local policy and senior supervision control all live work.
- **Outbound internal links:** `/free-mcqs`, `/glossary`, `/resources`, `/osce` — verified repository/inventory routes.
- **Inbound opportunities after publication:** `/about` (new-resident context), `/resources` (orientation/study planning), `/osce` (practical-learning boundary), `/institutions` (training-resource context). Add only after the theStacc URL is live in the sitemap.
- **Gate vector:** Factuality 5/5; Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5 (source-bounded orientation synthesis); Experience Integrity 5/5; Internal Linking 5/5; Conversion 3/5; Freshness 4/5 (local requirements must be rechecked).
