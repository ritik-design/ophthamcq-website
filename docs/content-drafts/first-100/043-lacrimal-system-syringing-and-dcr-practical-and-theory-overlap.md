...
| Structure | What to know for an exam | Common trap |
|---|---|---|
| Punctum | apposition, size, eversion/stenosis and location matter | assuming a visible punctum is patent |
| Canaliculus | upper/lower channels and a frequent common drainage segment | calling every reflux a distal NLD obstruction |
| Lacrimal sac | lies in the lacrimal fossa; sac tenderness or distension changes the story | forgetting the sac can harbour infection or a mass concern |
| Nasolacrimal duct | conducts tears toward the inferior meatus | confusing inferior meatus with middle meatus |
| Inferior turbinate/nasal cavity | relevant to intranasal examination and DCR ostium | treating nose as irrelevant in a “lacrimal” question |
...
| Observation during test | Mechanistic possibility | Important limitation |
|---|---|---|
| Fluid reaches throat/nose without reflux | functional passage may be present | does not exclude intermittent symptoms, pump failure or partial disease |
| Reflux through opposite punctum | obstruction distal to the common canalicular drainage may be possible | anatomy and technique affect the pattern; correlate clinically |
| Reflux through same punctum | proximal canalicular/punctal obstruction or poor entry may be possible | do not localise without considering whether the cannula entered correctly |
| Resistance / “hard stop” pattern | may help distinguish a proximal obstruction when correctly performed | terminology and interpretation require experienced examination; do not force |
| Mucopurulent reflux | sac infection/stasis may be present | needs clinical context and appropriate management, not an MCQ-only label |
...
The [AAO EyeWiki DCR overview](https://eyewiki.org/Dacryocystorhinostomy) and [StatPearls DCR chapter](https://www.ncbi.nlm.nih.gov/books/NBK557851/) are helpful background sources. They must be read as educational overviews; neither should be used as a patient-specific operation plan.

| Question | External DCR | Endoscopic/endonasal DCR |
|---|---|---|
| Access | skin incision over lacrimal sac region | intranasal endoscopic route |
| Exam advantage | direct sac exposure; familiar external anatomical landmarks | avoids a cutaneous incision and permits intranasal assessment |
| Exam caveat | scar, anatomy and surgical context matter | requires nasal access, equipment and relevant expertise |
| What not to claim | that it is universally superior | that it is universally scarless, easier or appropriate for every obstruction |
...
| `/products/instruments-drugs-practical-viva` | Instruments, Drugs & Practical Viva | Optional practical revision resource |
| `/free-mcqs/general` | general ophthalmology free MCQs | Retrieval practice |
| `/osce` | OSCE and viva resource page | Practical-exam route |

**Inbound opportunities:** `/topics/oculoplastics` in its lacrimal section; `/osce` near lacrimal-station preparation; `/products/instruments-drugs-practical-viva` where practical-viva use cases are described.

## Sources

1. [AAO EyeWiki: Dacryocystorhinostomy](https://eyewiki.org/Dacryocystorhinostomy) — DCR indications and approaches overview; checked 18 August 2026.
2. [StatPearls: Dacryocystorhinostomy](https://www.ncbi.nlm.nih.gov/books/NBK557851/) — anatomy, indications, procedure concepts and complication overview; checked 18 August 2026.
3. [ESOPRS: DCR and tubes](https://www.esoprs.eu/public-info/information/lacrimal-dacryocystorhinostomy-dcr-and-tubes/) — patient-facing supplementary explanation; not used as an operative protocol; checked 18 August 2026.
4. [Royal College of Ophthalmologists curriculum](https://curriculum.rcophth.ac.uk/) — training context; checked 18 August 2026.

## QA

**Factuality 5/5:** anatomy and DCR concepts are linked to authority sources; interpretation is explicitly qualified. **Search intent 5/5:** answers DCR MCQs, syringing and theory-practical overlap. **Reader value 5/5:** gives a localisation chain, documentation table and viva script. **Information gain 5/5:** makes the limits of irrigation explicit. **SEO 5/5:** focused keyword/entity coverage. **GEO 5/5:** direct answer, tables and visible sources. **Naturalness 5/5:** concise doctor-facing wording. **Experience integrity 5/5:** no invented experience. **Internal linking 5/5:** inventory-verified routes only. **Conversion 4/5:** resource links are clearly optional. **Freshness 4/5:** clinical policy and surgical details need final local/specialist confirmation before publication.
