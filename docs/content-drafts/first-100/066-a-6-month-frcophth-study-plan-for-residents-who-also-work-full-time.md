...
primary_keyword: "frcophth study plan"
...
This is a Part 1 study-planning template for doctors. It is not an official RCOphth timetable, a prediction of the time any individual needs, or a promise about an examination result. Check the current [RCOphth Part 1 examination page](https://www.rcophth.ac.uk/exams/rcophth-exams/part-1-frcophth-exam/), [examinations calendar](https://www.rcophth.ac.uk/exams/exams-calendar/) and the instructions issued for your sitting before fixing leave, booking travel or acting on any operational requirement.
...
| Week mode | When to use it | Minimum output | What you deliberately drop |
|---|---|---|---|
| Normal | routine rota, reasonable energy | three focused sessions, two short retrieval sessions, one weekend review | extra reading that does not repair an error |
| Minimum | nights, travel, acute service pressure | three 20–30 minute retrieval sessions and one short error-log review | new dense chapters and full mocks |
| Recovery | the first stable week after disruption | resume the current module plus one focused catch-up block | trying to “repay” every missed page or question |
...
Your first study session is administrative and takes less than an hour. Open the current Part 1 page, calendar, information pack and any candidate communication for your sitting. Save the links and record the date you checked them. Use the current [RCOphth curriculum handbook](https://www.rcophth.ac.uk/training-careers/training-routes/ophthalmic-specialist-training/the-ost-curriculum-2024/curriculum-handbook/) to understand the curriculum context.
...
Set up four working documents: a syllabus/checklist, the error log, a formula-and-units sheet, and a folder for diagrams or image prompts. Choose a limited reference stack. An AAO BCSC section can be useful for bounded reading; the AAO’s [BCSC study guidance](https://www.aao.org/young-ophthalmologists/yo-info/article/4-tips-prep-okap-with-bcsc) supports active planned use of its material. That does not make BCSC an official FRCOphth source. Pair any reading with retrieval the same day.
...
Evidence interpretation needs the same active approach. The NCBI Bookshelf overview of [Evidence-Based Medicine](https://www.ncbi.nlm.nih.gov/books/NBK470182/) is a terminology cross-check, not a College blueprint. Use tables and short abstracts to practise identifying a population, comparator, endpoint, bias and limitation. Do not collect definitions without applying them to a question.
...
|---|---|---|
| Knowledge | the fact, mechanism or relationship was absent | check a primary reference and make a retrieval prompt |
| Discrimination | you knew the options but missed the separator | build a two-column comparison table |
| Process | negation, units, arithmetic or misreading caused the miss | create a one-line check before committing |
| Timing | you knew it but rushed, stalled or changed correctly | practise shorter timed sets and flagging |
| Image | you named a pattern but could not localise or explain it | annotate, cover labels, redraw and retest |
...
| Session | Task | Evidence created |
|---|---|---|
| Session 1 | mixed questions before reading | tagged error themes |
| Session 2 | focused source check for one theme | mechanism, comparison or formula output |
| Session 3 | fresh topic questions | transfer check |
...
- [Royal College of Ophthalmologists: Part 1 FRCOphth examination](https://www.rcophth.ac.uk/exams/rcophth-exams/part-1-frcophth-exam/) — current Part 1 information gateway; checked 18 August 2026.
- [Royal College of Ophthalmologists: examinations calendar](https://www.rcophth.ac.uk/exams/exams-calendar/) — current dates and operational schedule gateway; checked 18 August 2026.
- [Royal College of Ophthalmologists: curriculum handbook](https://www.rcophth.ac.uk/training-careers/training-routes/ophthalmic-specialist-training/the-ost-curriculum-2024/curriculum-handbook/) — current curriculum context; checked 18 August 2026.
- [American Academy of Ophthalmology: four tips for preparing for OKAP with BCSC](https://www.aao.org/young-ophthalmologists/yo-info/article/4-tips-prep-okap-with-bcsc) — active-use guidance for sectional reading, not an FRCOphth endorsement; checked 18 August 2026.
- [NCBI Bookshelf: Evidence-Based Medicine](https://www.ncbi.nlm.nih.gov/books/NBK470182/) — general evidence-interpretation terminology reference; checked 18 August 2026.
...
- **Search intent:** resolves a working-resident planning problem with a rota-resilient process, rather than a generic six-month list.
- **Cannibalisation:** KEEP SEPARATE from queue 002 and `/exams/frcophth`; this page focuses on capacity, disruption and recovery while the Part 1 guide explains syllabus/format context.
- **Information gain:** normal/minimum/recovery modes, no-debt recovery rule, output-led study, mock debrief and error-specific interventions.
- **Claim discipline:** no hard-coded RCOphth date, fee, eligibility, timing, attempt, question-count, delivery or topic-weightage statement. Every institutional claim is linked to RCOphth; mutable facts have a final-check protocol.
- **Education boundary:** postgraduate exam education only; no guarantee, patient advice, endorsement or unsupported product claim.
- **Outbound internal manifest:**

| Source section | Destination | Anchor | Type | Why it belongs |
|---|---|---|---|---|
| Working-week pattern | `/exams/frcophth` | FRCOphth preparation guide | BODY_CONTEXTUAL | Exam-route context |
| Working-week pattern | `/free-mcqs/frcophth` | free FRCOphth sample questions | BODY_CONTEXTUAL | Short retrieval practice |
| Working-week pattern | `/products/frcophth-step-1-mcqs` | FRCOphth Step 1 MCQs sample page | BODY_CONTEXTUAL | Optional relevant resource, P1 orphan support |
| Revision layer | `/notes` | Handwritten Exam Ready Notes | BODY_CONTEXTUAL | Concise revision route with clear limitation |
| Revision layer | `/resources` | resource hub | BODY_CONTEXTUAL | Wider study-resource choice |

- **Inbound opportunities:** once the final article URL appears in the sitemap, link from `/exams/frcophth` in a working-alongside-training section; `/resources` next to study plans; `/free-mcqs/frcophth` near retrieval guidance; and published queue 002 in its execution-plan reference. No unpublished blog link is added now.
- **QA vector:** Factuality 5/5 (official requirements source-bound and mutable detail withheld); Search Intent 5/5 (working-resident plan answered); Reader Value 5/5 (capacity modes and recovery algorithm); Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5 (RCOphth-first sources); Experience Integrity 5/5 (no invented experience); Internal Linking 5/5 (five verified contextual `.org` routes); Conversion 4/5; Freshness 4/5 (explicit final recheck required).
