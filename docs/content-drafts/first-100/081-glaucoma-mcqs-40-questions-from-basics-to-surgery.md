...
primary_keyword: "glaucoma mcq questions"
secondary_keywords: ["glaucoma MCQs with answers", "glaucoma surgery MCQs", "ophthalmology glaucoma questions"]
...
1. **Which finding is most central to a diagnosis of glaucoma?**  
   ...
   **Why:** Raised IOP is an important risk factor and treatment target, but it is not itself the definition. Typical damage can occur with IOP measurements in the conventional reference range.[^egs]
...
3. **What investigation establishes angle anatomy?**  
   **Answer:** Gonioscopy.  
   **Why:** Van Herick assessment can screen peripheral chamber depth, but it does not replace gonioscopy for identifying angle structures, iridotrabecular contact or peripheral anterior synechiae.[^pac]
...
6. **Goldmann applanation tonometry is classically based on which principle?**  
   **Answer:** Imbert–Fick.  
   **Why:** In practice, the cornea is not an ideal thin, dry sphere. Corneal thickness and biomechanics influence interpretation, so a fixed numerical “correction” is not a complete answer.[^poag]
...
10. **Iris bombe is the characteristic anatomical result of which mechanism?**  
...
11. **A patent peripheral iridotomy is present but the angle remains narrow. What mechanism should the stem make you consider?**  
   **Answer:** A non-pupillary-block component, classically plateau iris configuration.  
   **Why:** Iridotomy relieves relative pupillary block; it does not change an anteriorly positioned ciliary body.[^pac]

12. **A painful red eye with haloes, nausea and a mid-dilated sluggish pupil should be treated in an MCQ as which pattern?**  
...
13. **Pseudoexfoliative material is classically sought at which two sites?**  
...
14. **A Krukenberg spindle is pigment deposited where?**  
...
15. **What feature makes neovascular glaucoma a secondary angle-closure process at a later stage?**  
...
16. **Steroid response is generally classified as what form of glaucoma mechanism?**  
...
17. **A widened ciliary-body band after blunt trauma suggests what?**  
...
18. **In uveitic glaucoma, can inflammation coexist with more than one pressure mechanism?**  
   **Answer:** Yes.  
...
19. **Which is a classic early glaucomatous field pattern: nasal step or homonymous hemianopia?**  
   **Answer:** Nasal step.  
...
20. **A Bjerrum scotoma follows what anatomy?**  
...
21. **Does an OCT printout with a red sector diagnose glaucoma by itself?**  
   **Answer:** No.  
   **Why:** Check scan quality, segmentation, disc anatomy, refractive context and concordance with examination and field. Database colour coding is a comparison tool, not a diagnosis.[^egs]

22. **What optic-disc change is more concerning than a large cup alone?**  
...
23. **A disc haemorrhage should be interpreted how in a glaucoma question?**  
...
24. **A single abnormal field should establish progression. True or false?**  
   **Answer:** False.  
   **Why:** Reliability indices, learning effect, media opacity, pattern and serial correlation matter. A repeatable change that agrees with disc/RNFL evidence is stronger.[^poag]

25. **Why can a relative afferent pupillary defect be absent in mild, symmetric POAG?**  
...
26. **The ISNT rule is best described as what?**  
...
27. **Which topical class classically increases uveoscleral outflow?**  
...
28. **What is the core pressure-lowering mechanism of topical carbonic-anhydrase inhibitors?**  
...
29. **Beta-blocker drops require particular caution with which broad history?**  
...
30. **Pilocarpine has what two immediately testable effects?**  
...
31. **Selective laser trabeculoplasty acts at which tissue?**  
...
32. **Compared with SLT, argon laser trabeculoplasty has more structural thermal effect. True or false?**  
   **Answer:** True.  
...
33. **Which laser directly addresses relative pupillary block?**  
...
34. **After a trabeculectomy, aqueous is intended to drain into what visible reservoir?**  
...
35. **Why may mitomycin C be used during filtration surgery?**  
...
36. **Name two exam-differential considerations for a shallow anterior chamber after filtration surgery.**  
...
37. **Where does a glaucoma drainage device ultimately direct aqueous?**  
...
38. **Cyclodestructive procedures lower IOP by acting on which structure?**  
...
39. **What is the classic triad in primary congenital glaucoma?**  
...
40. **Haab striae are breaks in which corneal layer?**  
...
- **Cannibalisation:** KEEP SEPARATE from queue 026 and `/topics/glaucoma`. Queue 026 is a 30-question high-yield fact companion; this is a 40-question progression set that extends through laser, filtering surgery, tubes and congenital glaucoma.
- **Differentiation:** every answer identifies the tested decision layer (mechanism, structure/function correlation, or production/outflow route), rather than supplying a bare fact list.
- **Outbound internal links:** `/topics/glaucoma`, `/free-mcqs`, `/products/glaucoma-notes` — verified repository routes.
- **Inbound opportunities after publication:** `/topics/glaucoma`, `/free-mcqs`, `/resources`, `/products/glaucoma-notes`.
- **Claim check:** educational only; no exam-outcome guarantee, individual treatment direction, pricing claim or unsupported product feature claim.
- **Gate result:** factuality 5/5; search intent 5/5; reader value 5/5; information gain 4/5; SEO 5/5; GEO 5/5; naturalness 5/5; experience integrity 5/5; internal linking 5/5; conversion 4/5; freshness 4/5.

[^egs]: European Glaucoma Society. [Terminology and Guidelines for Glaucoma, 5th edition](https://pubmed.ncbi.nlm.nih.gov/34675050/). Used for the disease framework, assessment principles and structure-function interpretation.
[^poag]: American Academy of Ophthalmology. [Primary Open-Angle Glaucoma Preferred Practice Pattern](https://www.aao.org/preferred-practice-pattern/primary-open-angle-glaucoma-ppp). Used for terminology, examination and serial assessment framing.
[^pac]: American Academy of Ophthalmology. [Primary Angle-Closure Disease Preferred Practice Pattern](https://pubmed.ncbi.nlm.nih.gov/34933744/). Used for angle classification, gonioscopy and angle-closure mechanisms.
