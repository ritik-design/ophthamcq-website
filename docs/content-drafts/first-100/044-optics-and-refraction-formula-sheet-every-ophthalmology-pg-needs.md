...
category: "Optics and Refraction"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "long-form-reviewed-draft"
primary_keyword: "ophthalmology optics formulas"
target_page: "/products/optics-notes"
...
| Use | Formula | Unit / assumption | Fast check |
|---|---|---|---|
| Dioptric power | `F = 1/f` | `f` in metres | A 0.50 m focal length is +2 D, not +200 D. |
| Vergence | `L = n/l` | refractive index `n`; signed distance `l` in metres | Parallel rays have zero vergence. |
| Thin lens | `L' = L + F` | same sign convention throughout | A plus lens increases vergence by its power. |
| Surface power | `F = (n' − n)/r` | signed radius in metres | More curvature means greater magnitude of power. |
| Lensmaker (thin lens in air) | `F = (n − 1)(1/r1 − 1/r2)` | radii signed by convention | It is a model, not a thick-IOL formula. |
| Prentice rule | `P = cF` | `c` in cm; `F` in D; answer in prism dioptres | 5 mm is 0.5 cm. |
| Spherical equivalent | `S + C/2` | retain the cylinder notation | It summarises, not replaces, a sphero-cylinder. |
| Transposition | `S' = S + C`; `C' = −C`; axis ±90° | keep axis 1–180° | Power in each principal meridian must match. |

The [NCBI overview of optics](https://www.ncbi.nlm.nih.gov/books/NBK470547/) is a useful terminology check. For examination work, reconcile notation with the named textbook, commonly Elkington or BCSC, before a sitting.
...
| Step | Example: `+2.00 / −3.00 × 20` |
|---|---|
| New sphere | `+2.00 + (−3.00) = −1.00` |
| New cylinder | reverse sign: `+3.00` |
| New axis | `20 + 90 = 110` |
...
- [NCBI Bookshelf: Optics](https://www.ncbi.nlm.nih.gov/books/NBK470547/)
- [NCBI Bookshelf: Refractive Error](https://www.ncbi.nlm.nih.gov/books/NBK574561/)
- Elkington AR, Frank HJ, Greaney MJ. *Clinical Optics*, 4th ed.
- AAO BCSC, *Fundamentals and Principles of Ophthalmology*.

## Editorial QA and link manifest

- Scope: postgraduate examination education only; not a refraction, contact-lens or IOL prescription protocol.
- Cannibalisation: KEEP SEPARATE from the commercial optics-notes page.
- Outbound internal: `/products/optics-notes`, `/products/ico-optics-refraction-mcqs-part-a`, `/free-mcqs/ico-fico`, `/exams/ico-fico` — all verified inventory routes.
- Inbound opportunities: `/notes`, `/exams/ico-fico`, `/resources`, `/free-mcqs/ico-fico`.
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 5; Competitive Superiority 4; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 4; Freshness 4.
