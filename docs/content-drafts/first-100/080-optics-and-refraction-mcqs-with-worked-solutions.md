---
title: "Optics and Refraction MCQs With Worked Solutions"
proposed_slug: "optics-and-refraction-mcqs-with-worked-solutions"
meta_description: "30 optics and refraction MCQs with worked solutions on lenses, vergence, astigmatism, accommodation and the calculation traps that cost marks."
excerpt: "Write the sign, units and formula before choosing an optics answer. Most errors happen before the arithmetic."
category: "Free MCQs"
author: "Dr. OphthaMCQ Editorial Team"
date: "2026-08-18"
status: "reviewed-draft"
primary_keyword: "optics and refraction mcq"
target_page: "/free-mcqs/general"
...
1. [Musa MJ, Zeppi M. *Spectacle Correction of Ametropias*. StatPearls, NCBI Bookshelf](https://www.ncbi.nlm.nih.gov/books/NBK585037/) — refractive-error and spectacle-correction terminology.
2. [StatPearls: *Hyperopia*, NCBI Bookshelf](https://www.ncbi.nlm.nih.gov/books/NBK560716/) — relaxed-focus position and hyperopic optical concepts.
3. [AAO EyeWiki: *Myopia*](https://eyewiki.org/Myopia) — myopic refractive state and axial mechanism overview.
4. [AAO EyeWiki: *Hyperopia*](https://eyewiki.org/Hyperopia) — hyperopic refractive state overview.
5. [AAO EyeWiki: *Presbyopia*](https://eyewiki.org/Presbyopia) — age-related loss of accommodation overview.

## Editorial QA and internal-link manifest

- **Cannibalisation:** KEEP SEPARATE from `/products/optics-notes`; this is free, worked retrieval practice, whereas the product page is a notes route.
- **Differentiation:** a fixed sign–units–formula method, a transposition check by principal meridians, and explicit explanation of common calculation errors.
- **Claim review:** independent optical facts are bound to NCBI/AAO sources above. No pass-rate, outcome, pricing, competitor, affiliation, or patient-management claim.
- **Outbound links:** `/free-mcqs/general` (mixed practice; BODY_CONTEXTUAL, P2); `/products/optics-notes` (underlying topic notes; BODY_CONTEXTUAL, P1); `/exams/ico-fico` (exam-context route; BODY_CONTEXTUAL, P0). All routes verified against the repository inventory.
- **Inbound opportunities:** `/free-mcqs/general` (“optics calculation practice”); `/products/optics-notes` (“worked optics MCQs”); `/resources` (“free optics revision questions”); `/exams/ico-fico` (“optics and refraction practice”). Add only where the live publishing system makes the article URL available.
