...
primary_keyword: "slit lamp viva questions"
secondary_keywords: ["slit lamp examination viva", "slit lamp illumination techniques", "slit lamp examination steps"]
target_page: "/osce"
...
The Standardization of Uveitis Nomenclature (SUN) Working Group published terminology and grading conventions for anterior-chamber cells and flare.[^sun] That does not mean every case in an OSCE should receive a grade from memory. Say, “I would grade anterior-chamber cells and flare using SUN if the examiner requires a grade,” then describe the finding you can justify. A number without a method is weak; a careful observation plus the correct standard is stronger.
...
**Why use retroillumination?** To view a lesion against reflected light, commonly from the iris or fundus depending on the structure examined. It is particularly useful when contrast reveals a subtle opacity better than direct illumination.[^eyewiki]
...
1. “I have positioned the patient and adjusted the instrument. I will compare both eyes.”
2. “On diffuse illumination, the lids/conjunctiva/cornea show …”
3. “On direct focal illumination and optical section, the lesion is located at … and measures/extends …”
4. “The anterior chamber shows … under the stated examination conditions.”
5. “The iris, pupil and lens show …”
6. “I used [technique] because it demonstrates [interface/plane/sign].”
7. “My provisional interpretation is …; I would clarify it with … and document the finding before management discussion.”
...
| Source section | Destination | Destination title | Anchor | Type | Priority | Reason |
|---|---|---|---|---|---|---|
| Practical-viva revision | `/osce` | OSCE, Practical & Viva Voce Ready Bundle | OSCE, Practical & Viva Voce Ready bundle | CTA | P0 | directly matches station preparation |
| Practical-viva revision | `/products/instruments-in-ophthalmology-notes` | Instruments in Ophthalmology | Instruments in Ophthalmology notes | BODY_CONTEXTUAL | P2 | relevant instrument review |
| Practical-viva revision | `/products/case-presentation-format-notes` | Ophthalmology Case Presentation Format | Ophthalmology Case Presentation Format | BODY_CONTEXTUAL | P2 | helps structure reported findings |

**Inbound opportunities:** `/osce` in a slit-lamp/instrument station list; `/products/instruments-in-ophthalmology-notes` alongside a sample or revision guide; `/exams/dnb` beside practical-viva preparation. Do not create an internal blog link until a live sitemap verifies it.

## Sources

[^eyewiki]: American Academy of Ophthalmology EyeWiki. [Slit Lamp Examination](https://eyewiki.org/Slit_Lamp_Examination). Used for illumination-method terminology and exam technique. URL checked 18 August 2026.

[^sun]: Jabs DA, Nussenblatt RB, Rosenbaum JT; Standardization of Uveitis Nomenclature Working Group. [Standardization of Uveitis Nomenclature for Reporting Clinical Data](https://pubmed.ncbi.nlm.nih.gov/16196117/). *American Journal of Ophthalmology*. 2005;140(3):509–516. Used for terminology and anterior-chamber cells/flare grading context. PubMed record URL checked 18 August 2026.

## QA

**Factuality 5/5:** instrument techniques are bound to an AAO educational reference; the cells/flare standard is bound to the original SUN consensus paper. **Search Intent 5/5:** answers slit-lamp viva questions with examination and follow-up language. **Reader Value 5/5:** provides sequence, technique-to-sign table, filters, Van Herick boundary, cells/flare language and a rehearsal script. **Information Gain 5/5:** turns a list of illumination types into a practical decision sequence. **Competitive Superiority 4/5:** high utility without unsupported claims. **SEO 5/5:** direct answer and keyword-aligned hierarchy. **GEO 5/5:** extractable answer blocks and tables. **Naturalness 5/5:** concise doctor-to-doctor instructions. **E-E-A-T 4/5:** authority source plus original consensus; recheck before publication. **Experience Integrity 5/5:** no fabricated personal experience. **Internal Linking 5/5:** only verified `.org` routes. **Conversion 4/5:** optional resources follow the educational material. **Freshness 4/5:** URLs checked 18 August 2026.
