...
primary_keyword: "pupillary reflex mcq"
target_page: "/topics/neuro-ophthalmology"
...
| In the stem | Record first | Name only after that |
|---|---|---|
| Unequal pupils | which pupil is abnormal; difference in bright and dim light; lids and eye movements | sympathetic or parasympathetic pattern |
| “Poor reaction to light” | direct response, consensual response, near response; side being illuminated | afferent versus efferent problem |
| Field diagram | monocular/bilateral; vertical or horizontal hemifield; congruity | pre-chiasmal, chiasmal or retrochiasmal localisation |
...
| Light shone in | Normal direct response | Normal consensual response | What an asymmetry may test |
|---|---|---|---|
| Right eye | right pupil constricts | left pupil constricts | right afferent input and both efferent outputs |
| Left eye | left pupil constricts | right pupil constricts | left afferent input and both efferent outputs |
...
| Pattern | Reasoning step | Exam association to consider |
|---|---|---|
| Anisocoria is greater in the dark | the smaller pupil failed to dilate | sympathetic pathway pattern, including Horner syndrome |
| Anisocoria is greater in bright light | the larger pupil failed to constrict | parasympathetic/sphincter pathway pattern |
| Difference is similar in both conditions and small | neither pupil is clearly failing through a lighting condition | physiological anisocoria is a possibility; stem context decides |
...
| Pattern | Broad localisation | Reasoning limit |
|---|---|---|
| Monocular defect | retina or optic nerve before the chiasm | field shape and ocular examination still matter |
| Bitemporal hemianopic pattern | optic chiasm | do not name a cause without the rest of the stem |
| Homonymous hemianopic pattern | retrochiasmal pathway | optic tract, radiations and occipital cortex remain possible |
| Homonymous superior quadrantanopic pattern | temporal radiation pattern is classic | real lesions may be incomplete or mixed |
| Homonymous inferior quadrantanopic pattern | parietal radiation pattern is classic | use only with the complete diagram/context |
...
|---|---|
| pupils react when the fellow eye is illuminated but not when this eye is illuminated | afferent input problem on the illuminated side |
| one pupil is smaller and the difference increases in the dark | impaired dilation of the smaller pupil; sympathetic pattern |
| one pupil is larger and the difference increases in light | impaired constriction of the larger pupil; parasympathetic/sphincter pattern |
| both temporal visual hemifields are absent | chiasmal-pattern defect |
| same visual hemifield is absent in both eyes | retrochiasmal-pattern defect |
...
- [AAO EyeWiki: Relative afferent pupillary defect](https://eyewiki.org/Relative_Afferent_Pupillary_Defect)
- [AAO EyeWiki: Horner syndrome](https://eyewiki.org/Horner_Syndrome)
- [AAO EyeWiki: Anisocoria](https://eyewiki.org/Anisocoria)
- [NCBI Bookshelf: Neuroanatomy, visual pathway](https://www.ncbi.nlm.nih.gov/books/NBK470539/)

## Editorial QA and link manifest

- Cannibalisation: KEEP SEPARATE from `/topics/neuro-ophthalmology`; this is an exam-pattern drill, not a topic hub.
- Outbound contextual links: `/topics/neuro-ophthalmology` (pillar revision), `/free-mcqs/general` and `/free-mcqs/high-yield` (mixed retrieval). All were verified against the content inventory and route inventory.
- Inbound opportunities: add a contextual “pupil and field pattern drill” link from `/topics/neuro-ophthalmology`, `/resources`, `/osce` and `/glossary` where editorially relevant.
- Claim classes: clinical statements are source-bound independent educational facts; no first-party performance, price, exam-result or clinical-treatment claims.
- Gate vector: Factuality 5/5 (source-bound); Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5; Conversion 4/5; Freshness 5/5.
