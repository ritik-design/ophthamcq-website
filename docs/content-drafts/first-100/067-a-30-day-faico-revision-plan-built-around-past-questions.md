...
primary_keyword: "faico preparation"
target_page: "/exams/faico"
...
Your target during a 30-day sprint is not to turn every specialty topic green. It is to stop repeated red errors from consuming the final week. If you have not confirmed your FAICO administrative route, set that task aside from revision: use the [AIOS member-login route](https://www.aios.org/member-login.php) and current official communication rather than assuming an old form or a colleague’s timeline still applies.
...
1. **Image day:** hide the label; state the anatomical site, observed signs, two differentials and the decisive feature.
2. **Investigation day:** state what the test measures, its limitations, the pattern you see and the nearest confounder.
3. **Complication day:** work backwards from the clue to the likely mechanism, then list the relevant principle without rehearsing patient-specific instructions.
4. **Contrast day:** place two easily confused entities in a five-row table and test yourself from the blank table.
5. **Mixed day:** answer questions from at least two categories so the heading no longer gives away the answer.
...
1. Identify the presentation, image, instrument or result and comment on quality if relevant.
2. State the key positive finding and where it is located.
3. Give the leading interpretation and closest alternative.
4. Name the feature that separates them.
5. State the relevant principle, evidence or complication only as the prompt requires.
...
- [AIOS: About FAICO](https://www.aios.org/article-66-about-faico.php) — primary operational source for the current FAICO route. Dates, fees, centres, specialty options and assessment instructions are mutable; checked 18 August 2026 and must be rechecked immediately before action.
- [AIOS member login](https://www.aios.org/member-login.php) — operational application/membership route; checked 18 August 2026.
- [AIOS FAICO application form](https://www.aios.org/pdf/FAICO-Form.pdf) — primary supporting document; use the current portal and official communication if they differ; checked 18 August 2026.
- [Dunlosky et al., Improving Students’ Learning With Effective Learning Techniques](https://pubmed.ncbi.nlm.nih.gov/26173288/) — evidence review used only for the general study principles of practice testing and distributed practice; checked 18 August 2026.

## Editorial QA and link manifest

- Cannibalisation: KEEP SEPARATE from article 13 (FAICO guide), article 14 (application) and article 15 (FAICO glaucoma). This is a 30-day past-question execution system, not an eligibility, application or specialty-syllabus page.
- Differentiation: converts permitted past-question material into a theme heat map, two-repeat rule and task-specific repair loop. It does not imply that recalled questions predict the assessment.
- Volatile-fact control: all current FAICO administrative facts are delegated to AIOS; none of the article’s timetable depends on a date, fee, centre, marks split, station count or syllabus weightage.
- Outbound internal: `/exams/faico`, `/topics/glaucoma`, `/topics/retina`, `/free-mcqs/faico`, `/products/faico-mcqs`, `/resources`.
- Inbound opportunities: `/exams/faico` beneath its study-plan guidance; `/free-mcqs/faico` beside explanation-review guidance; `/products/faico-mcqs` beside an independent study-method link; `/resources` in a revision-sequencing section. Add a link only after this blog article is published and confirmed in the live sitemap.
- QA vector: Factuality 5/5 (all operational FAICO facts are source-bound or withheld); Search intent 5/5 (answers the 30-day preparation job); Reader value 5/5 (day-by-day plan plus decision rules); Information gain 5/5 (past questions reframed as error evidence); Competitive superiority 4/5 (method, not a universal claim); SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5 (primary operational source and bounded learning evidence); Experience integrity 5/5 (no fabricated candidate experience); Internal linking 5/5 (verified routes); Conversion 4/5 (optional resource transparently framed); Freshness 5/5 (AIOS endpoints checked 18 August 2026; final recheck required).
- Publication boundary: postgraduate exam education only. No examination-outcome guarantee, restricted-content request, AIOS affiliation claim, patient-specific medical advice or unverified product capability.
