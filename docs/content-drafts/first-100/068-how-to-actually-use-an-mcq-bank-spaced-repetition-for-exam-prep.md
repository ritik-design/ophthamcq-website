...
primary_keyword: "how to use mcq bank"
...
Research supports retrieval practice and distributed practice as learning strategies, but it does not prescribe a magic interval or a universal number of questions for every resident. The [testing-effect experiment by Roediger and Karpicke](https://pubmed.ncbi.nlm.nih.gov/16507066/) and [Cepeda and colleagues’ distributed-practice review](https://pubmed.ncbi.nlm.nih.gov/16719566/) support the underlying logic: attempting retrieval and returning after time can improve later retention. Your interval must fit the exam date, posting and the difficulty of the material.
...
When an exam is close, shorten the interval and reduce new material. When the exam is distant, lengthen the gap after successful retrieval. The [Dunlosky review of learning techniques](https://pubmed.ncbi.nlm.nih.gov/26173288/) is useful background for the evidence boundary: effective study methods do not remove the need to adapt a plan to a learner and task.
...
1. Topic-wise 10–20 questions to map errors.
2. A second topic-wise set after repair, with new stems.
3. A small mixed set 48–72 hours later.
4. A larger mixed set after one to two weeks.
...
- [Roediger and Karpicke, *Test-Enhanced Learning*](https://pubmed.ncbi.nlm.nih.gov/16507066/) — experimental evidence used for the retrieval-practice principle; checked 18 August 2026.
- [Cepeda et al., *Distributed Practice in Verbal Recall Tasks*](https://pubmed.ncbi.nlm.nih.gov/16719566/) — review used for the distributed-practice principle; checked 18 August 2026.
- [Dunlosky et al., *Improving Students’ Learning With Effective Learning Techniques*](https://pubmed.ncbi.nlm.nih.gov/26173288/) — review used to frame study-technique evidence and limits; checked 18 August 2026.
...
- **Cannibalisation:** KEEP SEPARATE from the unverified live blog topic and from `/free-mcqs`; this is a method page, while the hub is a practice destination.
- **Differentiation:** error-type diagnosis, prompt-writing rules, a residency-week review queue and a decision rule for topic-wise versus mixed practice.
- **Education boundary:** exam study guidance for doctors only; no medical advice, outcome guarantee or claim that a product is an official resource.
- **Outbound internal manifest:** `/free-mcqs` (broad diagnostic route; P0); `/free-mcqs/general` (mixed practice; P2); `/glossary` (term repair; P3); `/topics/glaucoma`, `/topics/retina` (context routes; P1); `/products/high-yield-mcqs` (optional sample/product route; P0); `/exams/ico-fico`, `/exams/faico`, `/exams/dnb`, `/exams/frcophth` (exam-planning routes; P0). All are verified BODY_CONTEXTUAL routes.
- **Inbound opportunities:** `/free-mcqs` explanation/review copy; `/resources` study-method list; `/exams/dnb`, `/exams/ico-fico`, `/exams/faico`, `/exams/frcophth` question-practice sections; `/products/high-yield-mcqs` usage guidance. Add only after the final article URL appears in the live sitemap.
- **QA vector:** Factuality 5/5; Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5; Conversion 4/5; Freshness 4/5.
