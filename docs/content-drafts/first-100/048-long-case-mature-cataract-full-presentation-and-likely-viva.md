...
primary_keyword: "cataract long case ophthalmology"
target_page: "/osce"
...
1. General appearance and eye position; look for obvious asymmetry, previous scars, lid disease or signs that affect access.
2. Visual acuity, including the fellow eye as the station permits.
3. External examination and pupils.
4. Slit-lamp description: cornea, anterior chamber depth/activity, iris, pupil, pseudoexfoliative material if seen, and lens morphology.
5. IOP, with method and reading.
6. Posterior-segment view: state whether it is possible and what its limit is.
7. Fellow eye: lens, pressure, disc/macula view and any relevant asymmetry.
...
The [NICE cataracts in adults guideline](https://www.nice.org.uk/guidance/ng77), [EyeWiki cataract reference](https://eyewiki.org/Cataract) and [NCBI Bookshelf cataract review](https://www.ncbi.nlm.nih.gov/books/NBK539699/) provide reference context for cataract terminology and assessment. They are not a viva script and this article does not translate them into patient-specific management.
...
1. Have I recorded acuity and laterality accurately?
2. Which anterior-segment finding could make this more than a routine chronic cataract presentation?
3. What can I genuinely see behind the lens, and what can I not?
4. What does the fellow eye contribute to the differential or prognosis discussion?
5. Which phrase in my conclusion is an inference rather than an observation?
...
- [NICE, Cataracts in adults: management (NG77)](https://www.nice.org.uk/guidance/ng77)
- [EyeWiki, Cataract](https://eyewiki.org/Cataract)
- [NCBI Bookshelf, Cataract](https://www.ncbi.nlm.nih.gov/books/NBK539699/)

## Editorial QA and link manifest

- Research brief: `docs/content-research/048-mature-cataract-long-case-serp-brief.md`; research, authority ledger and detailed outline completed before draft.
- Cannibalisation: KEEP SEPARATE from `/topics/cataract`; this article answers practical long-case/viva intent.
- Scope gate: education for doctors only; no patient-specific investigation, treatment or prognosis recommendation; no outcome guarantee or affiliation claim.
- Outbound manifest: `/topics/cataract` | cataract study guide | BODY_CONTEXTUAL | P1; `/products/case-presentation-format-notes` | case-presentation format resource | BODY_CONTEXTUAL | P2; `/osce` | OSCE, Practical & Viva Voce Ready bundle | BODY_CONTEXTUAL/CTA | P0; `/products/short-term-phaco` | Short Term Phaco Notes | BODY_CONTEXTUAL | P2. All verified against inventory and routes.
- Inbound opportunities: `/topics/cataract` practical/viva subsection; `/osce` long-case collection; `/exams/dnb` practical preparation; `/products/case-presentation-format-notes` worked-example section.
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 5; Competitive Superiority 5; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 5; Freshness 5.
