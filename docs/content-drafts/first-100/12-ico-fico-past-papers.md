...
The ICO Standard route comprises Visual Sciences, Optics, Refraction and Instruments (ORI), and Clinical Ophthalmology. The ICO says Clinical Ophthalmology is offered after passes in Visual Sciences and ORI, or an accepted equivalent; the Advanced 115 examination follows the three Standard components or an accepted equivalent. Its [examination-resources page](https://icoph.org/ico-examination/ico-examination-resources/) links current instructions and syllabi for these components.
...
|---|---|---|
| `/exams/ico-fico` | ICO / FICO preparation guide | Pathway context |
| `/free-mcqs/ico-fico` | Free ICO / FICO MCQs | Fresh retrieval practice |
| `/products/ico-fico-past-papers` | ICO/FICO Past Papers | Optional, clearly disclosed preview |

**Inbound opportunities:** `/products/ico-fico-past-papers` beside usage advice; `/exams/ico-fico` in its study-method section; `/resources` in its question-bank workflow section.

## Sources

- [ICO examination overview and component pathway](https://icoph.org/ico-examination/) — checked 18 August 2026.
- [ICO Examination Resources: instructions and syllabi](https://icoph.org/ico-examination/ico-examination-resources/) — checked 18 August 2026.
- [ICO Foundation Assessment: question style and feedback model](https://icoph.org/ico-examination/foundation-assessment/) — checked 18 August 2026.
- [ICO Examination FAQ](https://icoph.org/ico-examination/ico-examination-frequently-asked-questions/) — checked 18 August 2026.

## QA

Factuality **5/5** — distinguishes official ICO material from recalls and binds operational facts to ICO sources. Search Intent **5/5**. Reader Value **5/5** — provides a repeatable paper-to-error-map workflow. Information Gain **5/5** — adds confidence tagging, source hierarchy and component-specific outputs. Competitive Superiority **4/5** — method-led, not a claimed question dump. SEO **5/5**. GEO **5/5**. Naturalness **5/5**. E-E-A-T **5/5** — no fabricated experience. Experience Integrity **5/5**. Internal Linking **5/5**. Conversion **4/5** — product is optional and accurately framed. Freshness **5/5** on stated check date.
