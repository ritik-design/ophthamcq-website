...
primary_keyword: "new ophthalmology drugs 2026"
target_page: "/products/ophthalmology-drugs-practical-pdf"
estimated_read_time: "5 minutes"
fact_check_date: "2026-08-18"
research_brief: "docs/content-research/096-ophthalmic-drug-device-approvals-serp-brief.md"
---
...
| Field | Example prompt for your own source check |
|---|---|
| Intervention | molecule/device and manufacturer-independent class |
| Condition | exact disease and severity/stage |
| Jurisdiction | which regulator’s decision are you describing? |
| Date | when was the source accessed and when was the action taken? |
| Evidence | trial/device-study design and primary endpoint |
| Restriction | age, prior treatment, monitoring, contraindication or access limit |
...
| Area | Mechanism/principle question | Evidence question | Limitation to name |
|---|---|---|---|
| Retina pharmacotherapy | Does it alter VEGF signalling, complement activity, inflammation or another target? | What comparison, outcome timing and population were used? | dosing burden, safety monitoring, eligibility and access may differ |
| Gene/cell-based interventions | What genetic defect or cellular function is the intervention intended to address? | What endpoint and follow-up duration support the claim? | durability, eligibility, delivery and long-term safety need exact source checking |
| Glaucoma drugs/devices | Does it reduce aqueous production, alter outflow or measure a pressure-related variable? | Is the evidence medical, procedural or diagnostic? | label, anatomy, operator training and follow-up matter |
| Corneal technology | Is the aim optical correction, tissue replacement, cross-linking or imaging? | What is the comparator and measured outcome? | tissue, patient selection, device setting and regulation are context-specific |
| AI/imaging | Is it screening support, image quality control, risk prediction or diagnostic output? | Was performance externally validated and in whom? | workflow, bias, human oversight and regulatory intended use are separate from accuracy |
...
The [American Academy of Ophthalmology education catalogue](https://www.aao.org/education/education-browse) is a verified .org learning-resource directory. Use regulator and label sources for status questions; the catalogue does not establish current approval status.

For drug-class and practical-viva revision, see [Ophthalmology Drugs Practical PDF](/products/ophthalmology-drugs-practical-pdf) and [Instruments & Drugs for Practical Exams/Viva](/products/instruments-drugs-practical-viva). For broader recent-advances note revision, use [Recent Advances in Ophthalmology](/products/recent-advances-ophthalmology-notes).

## Editorial QA and link manifest

- Cannibalisation decision: KEEP SEPARATE. This is a source-verification viva framework, not a claims list or product page.
- Differentiation statement: teaches candidates to separate jurisdiction, approval, evidence and availability in one compact answer.
- Source-bound claims: AAO education catalogue verified 200 on 2026-08-18; no named approval or availability claim is made.
- Clinical caveat: not prescribing or regulatory advice; check current official sources.
- Outbound internal manifest: `/products/ophthalmology-drugs-practical-pdf` | "Ophthalmology Drugs Practical PDF" | BODY_CONTEXTUAL/CTA | P2; `/products/instruments-drugs-practical-viva` | "Instruments & Drugs for Practical Exams/Viva" | BODY_CONTEXTUAL | P2; `/products/recent-advances-ophthalmology-notes` | "Recent Advances in Ophthalmology" | BODY_CONTEXTUAL | P2.
- Inbound opportunities: `/products/ophthalmology-drugs-practical-pdf`; `/products/recent-advances-ophthalmology-notes`; `/osce` (viva-source checking); `/resources`.
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 4; Competitive Superiority 4; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 4; Freshness 5.

[^fda]: US Food and Drug Administration. [Drugs@FDA](https://www.accessdata.fda.gov/scripts/cder/daf/) and [medical-device databases](https://www.fda.gov/medical-devices/device-advice-comprehensive-regulatory-assistance/medical-device-databases). Used only as US regulator search gateways.
[^ema]: European Medicines Agency. [Medicines](https://www.ema.europa.eu/en/medicines). Used only as an EU medicine-information gateway.
[^cdsco]: Central Drugs Standard Control Organization. [Official portal](https://cdsco.gov.in/opencms/opencms/en/Home/). Used only as an Indian regulator gateway; current records must be checked directly.
