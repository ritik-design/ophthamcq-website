...
primary_keyword: "handwritten notes revision"
target_page: "/notes"
...
| Revision job | Useful default | Why it can fit | Guardrail |
|---|---|---|---|
| Learn a mechanism or spatial pathway | handwritten sketch, tablet sketch or typed diagram built from memory | forces sequence and relationships into view | cover labels and redraw it tomorrow |
| Compare many changing fields | typed table | searchable, sortable and easy to attach a source/date | do not paste paragraphs into cells |
| Learn an image pattern | annotated printed/digital image plus a blank recall prompt | allows labels, arrows and repeated cover-test cycles | describe the pattern aloud without labels |
| Solve optics | handwritten calculations or a digital worksheet that shows each step | exposes units, sign convention and assumption | redo changed numbers closed-book |
| Capture a teaching-point during OPD or teaching | the quickest reliable capture method | preserves the question before it disappears | verify it in a named reference before making it a fact card |
| Final-week revision | error cards, comparison maps and marked questions | prioritises retrieval over rewriting | do not rebuild a complete notebook |
...
- [Mueller & Oppenheimer: The Pen Is Mightier Than the Keyboard (PubMed)](https://pubmed.ncbi.nlm.nih.gov/24760141/) — original experimental record; checked 18 August 2026.
- [Kobayashi: note-taking systematic review and meta-analysis (PMC)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10843647/) — evidence synthesis and heterogeneity context; checked 18 August 2026.
- [Dunlosky et al.: Improving Students’ Learning With Effective Learning Techniques (PMC)](https://pmc.ncbi.nlm.nih.gov/articles/PMC3741794/) — retrieval-practice and distributed-practice context; checked 18 August 2026.
...
- **Search intent:** answers a format-choice question through tasks and a repeatable workflow, not a false pen-versus-keyboard winner.
- **Cannibalisation:** KEEP SEPARATE from `/notes`; this is a study-method guide, while the destination is a resource category.
- **Information gain:** four-job selection matrix, source-to-retest loop and hybrid three-layer system separate note medium from retrieval.
- **Claim discipline:** all evidence claims are limited to the cited research; no outcome, universal-medium or product-learning claim.
- **Education boundary:** postgraduate exam education only; no clinical advice.
- **Outbound internal manifest:**

| Section | Destination | Anchor | Type | Purpose |
|---|---|---|---|---|
| Prepared notes | `/notes` | Handwritten Exam Ready Notes | BODY_CONTEXTUAL | Relevant concise-revision route |
| Topic examples | `/products/glaucoma-notes` | Glaucoma Exam Ready Notes page | BODY_CONTEXTUAL | Verified product/sample route |
| Topic examples | `/products/optics-notes` | Optics & Refraction Notes page | BODY_CONTEXTUAL | Verified product/sample route |
| Resource use | `/free-mcqs` | free MCQs with explanations | BODY_CONTEXTUAL | Retrieval test after note-making |
| Terminology | `/glossary` | ophthalmology glossary | BODY_CONTEXTUAL | Fast term lookup |
| Resource choice | `/resources` | resource hub | BODY_CONTEXTUAL | Broader resource route |

- **Inbound opportunities:** after sitemap verification, add from `/notes` in study-format guidance; `/resources` in study methods; `/free-mcqs` near error review; and relevant note pages where a “use alongside retrieval” explanation is appropriate. No unpublished blog URL is inserted now.
- **QA vector:** Factuality 5/5 (research claims source-bound and qualified); Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5 (six verified `.org` routes); Conversion 4/5; Freshness 4/5 (research should be rechecked before publication).
