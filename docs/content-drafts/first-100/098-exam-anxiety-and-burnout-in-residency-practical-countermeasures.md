...
primary_keyword: "medical exam anxiety"
...
1. What is the next non-negotiable clinical or administrative task?
2. What study task is small enough for the next available window?
3. What can wait without consequence?
4. Who should know if the workload or symptoms are becoming unsafe?
5. What is the next realistic sleep opportunity?
...
[^who]: [World Health Organization: Burn-out, occupational phenomenon](https://www.who.int/mental_health/evidence/burn-out/en/) — definition/scope; endpoint returned HTTP 200 on 18 August 2026.
...
- **Cannibalisation:** KEEP SEPARATE; no existing route covers resident study-load support with these explicit safety boundaries.
- **Differentiation:** workload-versus-worry split, duty-adjusted tiers, concrete escalation language and clear education-only limits.
- **Claim review:** no mental-health diagnosis, treatment, therapeutic efficacy, exam outcome, productivity, clinical-safety or product-learning claim.
- **Outbound links:** `/resources` (free resources hub; BODY_CONTEXTUAL, P2); `/free-mcqs` (free ophthalmology MCQs; BODY_CONTEXTUAL, P0); `/notes` (Handwritten Exam Ready Notes; BODY_CONTEXTUAL, P0). All inventory verified.
- **Inbound opportunities:** `/resources` (“resident study-load support”); `/about` (“educational support boundary”); `/exams/dnb` only where a duty-adjusted planning context is natural.
- **Gate result:** factuality 5/5; search intent 5/5; reader value 5/5; information gain 5/5; SEO 5/5; GEO 5/5; naturalness 5/5; experience integrity 5/5; internal linking 5/5; conversion 2/5; freshness 5/5.
