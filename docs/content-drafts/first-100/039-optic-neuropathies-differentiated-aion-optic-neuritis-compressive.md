...
primary_keyword: "optic neuropathy mcq"
...
| Tempo in the stem | Pattern it favours | What prevents overcalling it |
|---|---|---|
| sudden painless loss, often on waking | non-arteritic anterior ischaemic optic neuropathy (NAION) is a classic pattern | other acute retinal and optic-nerve disorders remain possible |
| acute to subacute loss with pain on eye movement | typical optic neuritis pattern | pain is not exclusive to neuritis; atypical neuritis exists |
| progressive loss over weeks to months | compressive or infiltrative process becomes more likely | compression may present variably; “progressive” must fit the rest of the examination |
| abrupt loss with systemic/inflammatory clues in an older patient | arteritic AION must be considered | the exam task is to recognise urgency, not to self-manage a patient |
...
| Finding | Why it supports a usual neuritis pattern | Why it is not decisive alone |
|---|---|---|
| pain on eye movement | common association in typical presentations | pain also occurs in orbital and other inflammatory processes |
| reduced colour vision / central scotoma | supports optic-nerve dysfunction | occurs across optic neuropathies |
| normal early disc | fits retrobulbar neuritis | also possible in posterior ischaemia or compression |
| enhancement on appropriate MRI | can support inflammatory optic-nerve involvement | imaging must match clinical site and differential |
...
| Feature | AION | Optic neuritis | Compressive neuropathy |
|---|---|---|---|
| usual tempo | acute | acute/subacute | often progressive |
| pain | often absent in NAION | pain on eye movement is a classic clue | variable |
| disc early | commonly swollen in anterior disease | normal or swollen | normal, swollen or later pale depending on site/duration |
| field association | altitudinal-type defect is classic | central/cecocentral defect can occur | depends on anatomical site |
| context that moves it up | vascular or arteritic clues | inflammatory/demyelinating context | progressive structural, orbital or neurological clues |
| anti-rule | not every acute swollen disc is NAION | no single pain or MRI feature proves it | not every compression is slow or pale at presentation |
...
- [AAO: Ischemic optic neuropathy](https://www.aao.org/education/disease-review/ischemic-optic-neuropathy)
- [NCBI Bookshelf: Optic neuritis](https://www.ncbi.nlm.nih.gov/books/NBK557853/)
- [Optic Neuritis Study Group: MRI in acute optic neuritis (PubMed)](https://pubmed.ncbi.nlm.nih.gov/11919062/)
- [NCBI Bookshelf: Compressive optic neuropathy](https://www.ncbi.nlm.nih.gov/books/NBK560782/)

## Editorial QA and link manifest

- Cannibalisation: KEEP SEPARATE from `/topics/neuro-ophthalmology`; the article supplies a tempo-first comparative drill.
- Outbound contextual links: `/topics/neuro-ophthalmology` and `/free-mcqs/general`, both verified existing .org routes.
- Inbound opportunities: `/topics/neuro-ophthalmology`, `/resources`, `/osce` and `/topics/retina` can add a contextual link where their copy discusses afferent defects or fields.
- Claim classes: independent clinical facts are source-bound; no patient-management instructions, performance guarantees or unverified OphthaMCQ claims.
- Gate vector: Factuality 5/5; Search Intent 5/5; Reader Value 5/5; Information Gain 5/5; Competitive Superiority 4/5; SEO 5/5; GEO 5/5; Naturalness 5/5; E-E-A-T 4/5; Experience Integrity 5/5; Internal Linking 5/5; Conversion 4/5; Freshness 5/5.
