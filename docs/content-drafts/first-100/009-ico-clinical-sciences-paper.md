...
There are two checklists. The administrative checklist belongs to the ICO: exam type, current regulations, application window, documentation, permitted materials and scoring instructions. Use the official [examination types page](https://icoph.org/ico-examination/type-of-ico-examinations/) and, where necessary, the [ICO examination contact route](https://icoph.org/ico-examination/contact-ico-exams/). Do not infer a rule from another candidate's sitting.
...
- [International Council of Ophthalmology: types of ICO examinations](https://icoph.org/ico-examination/type-of-ico-examinations/) — verify route terminology and current information.
- [International Council of Ophthalmology: contact ICO examinations](https://icoph.org/ico-examination/contact-ico-exams/) — use for sitting-specific uncertainty.
...
| Resources | /products/ico-fico-past-papers | ICO/FICO Past Papers | BODY_CONTEXTUAL | Relevant P0 product |
| Resources | /topics/retina | retina study guide | BODY_CONTEXTUAL | Topic repair |
| Resources | /topics/glaucoma | glaucoma study guide | BODY_CONTEXTUAL | Topic repair |
| Resources | /topics/cornea | cornea study guide | BODY_CONTEXTUAL | Topic repair |

**Inbound opportunities:** `/exams/ico-fico`, `/resources`, `/topics/retina`, `/topics/glaucoma` and `/topics/cornea` after publication. **Lateral blog links:** NO_LINK until live sitemap verification.

## QA

Factuality 5/5 — changing exam facts source-bound; Search intent 5/5; Reader value 5/5 — decision and image framework; Information gain 5/5; SEO 5/5; GEO 5/5; Naturalness 4/5; E-E-A-T 4/5; Experience integrity 5/5; Internal linking 5/5; Conversion 4/5; Freshness 5/5.
