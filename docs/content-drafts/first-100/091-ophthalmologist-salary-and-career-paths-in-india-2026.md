...
primary_keyword: "ophthalmologist salary india"
target_page: "/about"
...
1. Is it fixed monthly compensation, annual CTC, revenue share or gross receipts?
2. Does it include variable incentives, on-call work, travel or accommodation?
3. Is the doctor a resident, fellow, junior consultant or established surgeon?
4. Which city and patient segment does it represent?
5. Is it before tax and professional expenses?
6. Is the data recent and independently documented?
...
For an academic career, start documenting presentations, audits, publications and teaching activity early. The [American Academy of Ophthalmology education catalogue](https://www.aao.org/education/education-browse) is a verified .org learning-resource directory for ongoing education; it is not an Indian employment authority and does not endorse OphthaMCQ.
...
An individual current listing can be checked through the Government of India’s [National Career Service](https://www.ncs.gov.in/) gateway, but one listing is not a national pay benchmark.[^1] The [Ministry of Health and Family Welfare](https://www.mohfw.gov.in/) is a policy gateway, not an authority on a private employer’s offer.[^2] In other words, use official sources to establish what they actually control, and use the employer’s dated written offer for the offer itself.
...
[^1]: Government of India, National Career Service. [National Career Service portal](https://www.ncs.gov.in/). Live-checked 18 August 2026. Use a current individual listing as a dated lead, not as a market-wide salary source.
...
- Cannibalisation decision: KEEP SEPARATE. `/about` is a company/trust page; this is an independent career-decision framework.
- Differentiation statement: replaces unreliable salary headlines with an offer-comparison model and practical questions for each work arrangement.
- Source-bound claims: no salary figures or market-wide earning claims are made. National Career Service and MoHFW gateways were live-checked; NMC regulatory gateway is explicitly held for direct final-editor recheck because automated TLS validation failed.
- Career caveat: compensation and contracts vary; readers must verify current local terms and obtain professional advice.
- Outbound internal manifest: `/about` | "About OphthaMCQ" | BODY_CONTEXTUAL | P2; `/exams` | "ophthalmology exam guides" | BODY_CONTEXTUAL | P0.
- Inbound opportunities: `/about` (career-resources link); `/resources` (career planning collection); `/exams` (post-exam career pathway); `/institutions` only if a trainee-career resource section is added.
- QA vector: Factuality 5; Search Intent 5; Reader Value 5; Information Gain 5; Competitive Superiority 4; SEO 5; GEO 5; Naturalness 5; E-E-A-T 4; Experience Integrity 5; Internal Linking 5; Conversion 3; Freshness 4.
