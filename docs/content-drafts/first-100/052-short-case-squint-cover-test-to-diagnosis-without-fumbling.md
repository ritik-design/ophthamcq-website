...
primary_keyword: "squint examination steps"
target_page: "/osce"
...
1. **Set the condition.** Distance or near? With habitual correction if relevant? What is the accommodative target?
2. **Observe alignment and fixation.** Head posture, lids, corneal reflections, obvious deviation and whether each eye fixes.
3. **Choose the test.** Cover–uncover for a manifest deviation; alternate cover for dissociation and the total deviation.
4. **Describe the eye that moves.** Name the eye and its direction of movement before naming the deviation.
5. **Measure and contextualise.** Record the method, prism direction and magnitude if measurement is possible; then assess motility and any gaze dependence.

The [AAPOS prism-and-cover-test reference](https://www.aapos.org/glossary/prism-and-cover-test) supports this basic distinction between cover testing and prism quantification. Its terminology is useful for revision; it is not a substitute for the station brief in front of you.
...
This is not an invitation to prescribe tests or management from a short-case prompt. It shows the examiner that you know the limits of one manoeuvre. The [RCOphth curriculum](https://curriculum.rcophth.ac.uk/) is useful background on capability-based ophthalmic training, but it does not supply a universal marking scheme for every university or DNB practical examination.
...
1. **“There is no movement on cover–uncover but movement on alternate cover. What does that change?”** Explain that a latent component has been revealed and you would quantify the total deviation.
2. **“The distance and near measurements are different. What must be documented?”** State both test conditions and measurements; do not force one number to represent both.
3. **“The deviation changes in left gaze.”** Describe the incomitance and complete targeted motility assessment before attaching a cause.
4. **“The child does not fixate on the first target.”** Adapt to an age-appropriate engaging target, document the limitation and return to the test rather than inventing a value.
5. **“Give your conclusion in one sentence.”** Use movement → interpretation → limitation: “The observed refixation movement supports … under these conditions; I would correlate it with motility and the wider examination.”
...
1. [AAPOS: Prism and cover test](https://www.aapos.org/glossary/prism-and-cover-test) — cover-test and prism-cover-test terminology; checked 18 August 2026.
2. [NCBI Bookshelf: Strabismus](https://www.ncbi.nlm.nih.gov/books/NBK560782/) — phoria/tropia and clinical-assessment context; checked 18 August 2026.
3. [Royal College of Ophthalmologists curriculum](https://curriculum.rcophth.ac.uk/) — ophthalmic-training context only; checked 18 August 2026.

## Editorial QA and link manifest

**Cannibalisation:** KEEP SEPARATE. The page targets a timed squint short-case workflow; it does not replace the broad paediatric topic guide or the `/osce` practical-resource page.

**Claim controls:** Independent clinical facts are source-bound. The article gives examination-rehearsal language, not patient advice, a definitive diagnosis, an operative dose, a pass guarantee or an unsupported product claim.

| Source section | Destination | Anchor text | Anchor type | Reason | Priority |
|---|---|---|---|---|---|
| Resource close | `/topics/pediatric-ophthalmology` | paediatric ophthalmology study guide | semantic | Wider strabismus revision | P2 |
| Resource close | `/osce` | OSCE, Practical & Viva Voce Ready bundle | descriptive | Most relevant practical hub | P0 |
| Resource close | `/products/instruments-in-ophthalmology-notes` | sample pages for Instruments in Ophthalmology | descriptive | Practical-resource preview | P2 |
| Resource close | `/glossary` | ophthalmology glossary | semantic | Terminology support | P3 |

**Inbound opportunities:** `/osce` in a strabismus/motility-station section; `/topics/pediatric-ophthalmology` in practical-examination copy; `/resources` in a short-case-revision section; `/products/instruments-in-ophthalmology-notes` beside practical-equipment content. Add only where context genuinely supports the link.

**QA vector:** Factuality 5/5 (three live-checked authority sources; scope caveated); Search Intent 5/5 (answers step, cover-test, measurement and presentation queries); Reader Value 5/5 (condition-to-report loop and timed drill); Information Gain 5/5 (observable reporting framework); Competitive Superiority 4/5 (useful structure, no false experience claim); SEO 5/5; GEO 5/5 (direct answer, tables and source binding); Naturalness 5/5; E-E-A-T 4/5 (authority-led, no fabricated credentials); Experience Integrity 5/5; Internal Linking 5/5 (all four `.org` routes live-checked); Conversion 4/5 (optional, contextual resources); Freshness 5/5 (checked 18 August 2026; recheck before publication).
