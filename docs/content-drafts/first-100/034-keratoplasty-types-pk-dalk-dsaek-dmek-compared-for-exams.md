...
PK replaces a full-thickness corneal button. The [AAO-hosted EyeWiki overview of PK](https://eyewiki.org/Penetrating_Keratoplasty) is a useful educational reference for the core terminology and complications, while surgical decisions remain case-specific.
...
DALK removes diseased anterior corneal tissue while preserving the recipient Descemet membrane and endothelium. That retained host endothelium is the defining contrast with PK. A [peer-reviewed DALK review](https://pubmed.ncbi.nlm.nih.gov/29635194/) describes its use in stromal pathology and the importance of the interface/Descemet plane.
...
Descemet stripping automated endothelial keratoplasty (DSAEK) uses donor endothelium and Descemet membrane with a thin amount of posterior donor stroma. The stromal component is its simplest contrast with DMEK. A [DSAEK review](https://pubmed.ncbi.nlm.nih.gov/21242775/) provides the foundational terminology and clinical context.
...
Descemet membrane endothelial keratoplasty (DMEK) transplants donor Descemet membrane and endothelium without the stromal layer included in DSAEK. The [DMEK review](https://pubmed.ncbi.nlm.nih.gov/25569353/) is a peer-reviewed source for that tissue distinction and its place in endothelial keratoplasty.
...
The [corneal transplantation review in StatPearls](https://www.ncbi.nlm.nih.gov/books/NBK559033/) is a useful cross-check for general terminology. For an exam, do not claim a fixed complication rate unless the question gives a source and a population. Rates vary by indication, technique and era.

## Six common viva traps

1. **Calling DALK an endothelial procedure.** It preserves host endothelium; it is an anterior/stromal procedure.
2. **Forgetting the stromal component in DSAEK.** This is the key contrast with DMEK.
3. **Calling every corneal transplant “PK.”** State whether it is full thickness, anterior lamellar or posterior lamellar.
4. **Saying DMEK is always best.** Thinner tissue does not erase case selection and technical context.
5. **Confusing rejection with failure.** Explain the category and the mechanism.
6. **Answering a surgical choice without naming the diseased layer.** The pathology-to-tissue chain is usually what the question is testing.
...
| `/osce` | OSCE, Practical & Viva Voce Ready | practical/viva route |
| `/notes` | Handwritten Exam Ready Notes | broad revision route |

**Inbound opportunities:** `/topics/cornea` near keratoplasty; `/osce` within surgical-viva preparation; `/resources` in the cornea-resource section. Do not invent a related blog URL while the blog feed is not sitemap-verified.

## Sources

1. [Penetrating Keratoplasty, EyeWiki](https://eyewiki.org/Penetrating_Keratoplasty) — AAO-hosted educational overview of full-thickness graft terminology and complications; checked 18 August 2026.
2. [Deep anterior lamellar keratoplasty review](https://pubmed.ncbi.nlm.nih.gov/29635194/) — DALK tissue, indications and interface concepts; checked 18 August 2026.
3. [Descemet stripping automated endothelial keratoplasty review](https://pubmed.ncbi.nlm.nih.gov/21242775/) — DSAEK graft composition and context; checked 18 August 2026.
4. [Descemet membrane endothelial keratoplasty review](https://pubmed.ncbi.nlm.nih.gov/25569353/) — DMEK graft composition and endothelial-keratoplasty context; checked 18 August 2026.
5. [Corneal Transplantation, StatPearls](https://www.ncbi.nlm.nih.gov/books/NBK559033/) — terminology and complication cross-check; checked 18 August 2026.

## QA

**Factuality 5/5:** each tissue and complication statement is source-bound; no outcome rate is invented. **Search intent 5/5:** directly compares all four procedures. **Reader value 5/5:** uses a layer-to-graft decision method, comparison tables and viva script. **Information gain 5/5:** avoids patient-explainer simplification and blanket recommendations. **SEO 5/5:** procedure names and comparison terms are prominent. **GEO 5/5:** direct answer, extractable tables and visible sources. **Naturalness 5/5:** clear postgraduate language. **Experience integrity 5/5:** no fabricated surgical experience. **Internal linking 5/5:** verified .org destinations only. **Conversion 3/5:** optional educational-resource links are disclosed. **Freshness 4/5:** surgical practice must be rechecked before publication.
