...
primary_keyword: "glaucoma long case"
target_page: "/osce"
...
1. **Observed level:** “There is raised IOP by this method,” “the angle appears open on this description,” “there is rim thinning/notching,” “the field is unreliable/reliable.”
2. **Syndrome level:** “The structural and functional findings are/are not consistent with glaucomatous optic neuropathy.”
3. **Subtype level:** “Primary open-angle glaucoma is supported only if the full phenotype and exclusion of secondary causes fit; the relevant competing mechanisms are …”
...
- [NICE, Glaucoma: diagnosis and management (NG81)](https://www.nice.org.uk/guidance/ng81)
- [EyeWiki, Primary Open-Angle Glaucoma](https://eyewiki.org/Primary_Open-Angle_Glaucoma)
- [NCBI Bookshelf, Open Angle Glaucoma](https://www.ncbi.nlm.nih.gov/books/NBK441887/)

## Editorial QA and link manifest

- Research brief: `docs/content-research/049-glaucoma-long-case-serp-brief.md`; exact-query review, authority ledger, information-gain plan and detailed outline are complete.
- Cannibalisation: KEEP SEPARATE from `/topics/glaucoma` and `/products/glaucoma-notes`; this is a practical long-case/correlation workflow.
- Scope gate: exam education only. No patient-specific diagnosis, target pressure, treatment recommendation or outcomes claim.
- Outbound manifest: `/topics/glaucoma` | glaucoma study guide | BODY_CONTEXTUAL | P1; `/products/glaucoma-notes` | Glaucoma Exam Ready Notes | BODY_CONTEXTUAL | P0; `/osce` | OSCE, Practical & Viva Voce Ready bundle | BODY_CONTEXTUAL/CTA | P0; `/exams/dnb` | DNB Ophthalmology preparation guide | BODY_CONTEXTUAL | P0; `/products/case-presentation-format-notes` | case-presentation format resource | BODY_CONTEXTUAL | P2. Each route appears in inventory and exists in the repo.
- Inbound opportunities: `/topics/glaucoma` practical-case section; `/products/glaucoma-notes` study-workflow section; `/osce` long-case list; `/exams/dnb` practical-revision section.
