...
primary_keyword: "ophthalmology viva questions"
target_page: "/osce"
...
**Discriminator:** Its conceptual value is distinguishing appositional angle contact from peripheral anterior synechiae and assessing configuration. Do not demonstrate a manoeuvre on a patient or turn this into laser advice in a viva. The [AAO gonioscopy reference](https://eyewiki.org/Gonioscopy) describes the static and dynamic distinction.
...
- [AAO EyeWiki: Gonioscopy](https://eyewiki.org/Gonioscopy) (accessed 18 August 2026).
- [NCBI Bookshelf: Gonioscopy](https://www.ncbi.nlm.nih.gov/books/NBK554432/) (accessed 18 August 2026).
- [AAO EyeWiki: Slit Lamp Examination](https://eyewiki.org/Slit_Lamp_Examination) (accessed 18 August 2026).
- [AAO EyeWiki: Relative Afferent Pupillary Defect](https://eyewiki.org/Relative_Afferent_Pupillary_Defect) (accessed 18 August 2026).
- [Royal College of Ophthalmologists: OST curriculum updates](https://www.rcophth.ac.uk/training-careers/training-routes/ophthalmic-specialist-training/the-ost-curriculum-2024/ost-curriculum-updates/) (accessed 18 August 2026).

## Editorial QA and link manifest

- **Intent and scope:** practical-viva rehearsal for PG doctors; 20 question patterns, not a recalled bank or official blueprint.
- **Information gain:** every prompt uses first sentence → discriminating point → stop line, making it a method for answering rather than a recall dump.
- **Clinical boundary:** no patient-specific diagnosis, treatment, dosage, procedural demonstration or local exam-rule claim.
- **Source check:** all five authority sources were live-checked on 18 August 2026 and are used in the prose; no source is presented as an Indian university viva authority.
- **Outbound internal links:** `/products/read-ophthalmology-reports-tests` (report interpretation, P1); `/products/instruments-drugs-practical-viva` (tray/bottle practice, P1); `/osce` (practical hub, P0); `/glossary` (terminology, P3). All are verified `.org` routes.
- **Inbound opportunities:** `/osce` in its viva practice route; `/resources` in a practical revision path; relevant instruments/drugs and reports/tests product pages as a companion article. Recommendations only; no unrelated page edits made.
- **QA vector:** factuality 4/5; search intent 5/5; reader value 5/5; information gain 5/5; SEO 4/5; GEO 4/5; naturalness 4/5; experience integrity 5/5; internal linking 5/5; conversion 4/5; freshness 4/5.
